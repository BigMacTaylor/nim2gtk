...
proc gst_aggregator_get_force_live(self: ptr Aggregator00): gboolean {.
    importc, libprag.}

proc getForceLive*(self: Aggregator): bool =
  toBool(gst_aggregator_get_force_live(cast[ptr Aggregator00](self.impl)))

proc forceLive*(self: Aggregator): bool =
  toBool(gst_aggregator_get_force_live(cast[ptr Aggregator00](self.impl)))

proc gst_aggregator_get_ignore_inactive_pads(self: ptr Aggregator00): gboolean {.
    importc, libprag.}

proc getIgnoreInactivePads*(self: Aggregator): bool =
  toBool(gst_aggregator_get_ignore_inactive_pads(cast[ptr Aggregator00](self.impl)))

proc ignoreInactivePads*(self: Aggregator): bool =
  toBool(gst_aggregator_get_ignore_inactive_pads(cast[ptr Aggregator00](self.impl)))
...
proc gst_aggregator_set_force_live(self: ptr Aggregator00; forceLive: gboolean) {.
    importc, libprag.}

proc setForceLive*(self: Aggregator; forceLive: bool = true) =
  gst_aggregator_set_force_live(cast[ptr Aggregator00](self.impl), gboolean(forceLive))

proc `forceLive=`*(self: Aggregator; forceLive: bool) =
  gst_aggregator_set_force_live(cast[ptr Aggregator00](self.impl), gboolean(forceLive))

proc gst_aggregator_set_ignore_inactive_pads(self: ptr Aggregator00; ignore: gboolean) {.
    importc, libprag.}

proc setIgnoreInactivePads*(self: Aggregator; ignore: bool = true) =
  gst_aggregator_set_ignore_inactive_pads(cast[ptr Aggregator00](self.impl), gboolean(ignore))

proc `ignoreInactivePads=`*(self: Aggregator; ignore: bool) =
  gst_aggregator_set_ignore_inactive_pads(cast[ptr Aggregator00](self.impl), gboolean(ignore))
...
proc scBufferConsumed*(self: AggregatorPad;  p: proc (self: ptr AggregatorPad00; obj: ptr gst.Buffer00; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
...
proc gst_aggregator_pad_is_inactive(self: ptr AggregatorPad00): gboolean {.
    importc, libprag.}

proc isInactive*(self: AggregatorPad): bool =
  toBool(gst_aggregator_pad_is_inactive(cast[ptr AggregatorPad00](self.impl)))
...
proc gst_base_src_push_segment(self: ptr BaseSrc00; segment: ptr gst.Segment00): gboolean {.
    importc, libprag.}

proc pushSegment*(self: BaseSrc; segment: gst.Segment): bool =
  toBool(gst_base_src_push_segment(cast[ptr BaseSrc00](self.impl), cast[ptr gst.Segment00](segment.impl)))
...
proc putBytes*(self: BitWriter; data: seq[uint8] | string;
    nbytes: int): bool =
  toBool(gst_bit_writer_put_bytes(cast[ptr BitWriter00](self.impl), cast[ptr uint8](unsafeaddr(data[0])), uint32(nbytes)))
...
type
  TypeFindData00* {.pure.} = object
  TypeFindData* = ref object
    impl*: ptr TypeFindData00
    ignoreFinalizer*: bool
...
proc gst_type_find_helper_for_buffer_with_caps(obj: ptr gst.Object00; buf: ptr gst.Buffer00;
    caps: ptr gst.Caps00; prob: var gst.TypeFindProbability): ptr gst.Caps00 {.
    importc, libprag.}

proc typeFindHelperForBufferWithCaps*(obj: gst.Object = nil; buf: gst.Buffer;
    caps: gst.Caps; prob: var gst.TypeFindProbability = cast[var gst.TypeFindProbability](nil)): gst.Caps =
  let impl0 = gst_type_find_helper_for_buffer_with_caps(if obj.isNil: nil else: cast[ptr gst.Object00](obj.impl), cast[ptr gst.Buffer00](buf.impl), cast[ptr gst.Caps00](caps.impl), prob)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc gst_type_find_helper_for_data_with_caps(obj: ptr gst.Object00; data: ptr uint8;
    size: uint64; caps: ptr gst.Caps00; prob: var gst.TypeFindProbability): ptr gst.Caps00 {.
    importc, libprag.}

proc typeFindHelperForDataWithCaps*(obj: gst.Object = nil; data: seq[uint8] | string;
    caps: gst.Caps; prob: var gst.TypeFindProbability = cast[var gst.TypeFindProbability](nil)): gst.Caps =
  let size = uint64(data.len)
  let impl0 = gst_type_find_helper_for_data_with_caps(if obj.isNil: nil else: cast[ptr gst.Object00](obj.impl), cast[ptr uint8](unsafeaddr(data[0])), size, cast[ptr gst.Caps00](caps.impl), prob)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc gst_type_find_list_factories_for_caps(obj: ptr gst.Object00; caps: ptr gst.Caps00): ptr glib.List {.
    importc, libprag.}

proc typeFindListFactoriesForCaps*(obj: gst.Object = nil; caps: gst.Caps): seq[gst.TypeFindFactory] =
  let resul0 = gst_type_find_list_factories_for_caps(if obj.isNil: nil else: cast[ptr gst.Object00](obj.impl), cast[ptr gst.Caps00](caps.impl))
  if resul0.isNil:
    return
  result = glistObjects2seq(gst.TypeFindFactory, resul0, true)
  g_list_free(resul0)
# === remaining symbols:
