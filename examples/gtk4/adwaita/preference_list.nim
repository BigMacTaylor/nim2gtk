import nim2gtk/[adw, gtk4, gobject, gio]
import std/with
...
proc createPage1(): Widget =
  ...
  listExpanderRow0.addRow newButton("Test").toActionRow("Button")
...
proc createPage2(): Widget =
  ...
  with group:
    ...
    add newDropDownFromStrings(["Nim", "Vala", "Rust", "Python"]).toActionRow(
      "Drop Down"
    )
