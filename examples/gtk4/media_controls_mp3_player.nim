...
type ControlWithMediaFile = tuple[file: MediaFile, controls: MediaControls]
...
proc appActivate(app: Application) =
  ...
  mediaPathEntry.buffer.connect(
    "inserted_text", entryChanged, (mediaFile, mediaControls)
  )
