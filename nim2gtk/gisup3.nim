const
  SCA = [
    ...
    "touch_event!gtk.Widget!1!(self: gtk.Widget; obj: gdk.Event): bool!(self: ptr gtk.Widget00; obj: ptr gdk.Event00): gboolean",
    ...
    "add!gtk.Container!1!(self: gtk.Container; obj: gtk.Widget)!(self: ptr gtk.Container00; obj: ptr gtk.Widget00)",
    "remove!gtk.Container!1!(self: gtk.Container; obj: gtk.Widget)!(self: ptr gtk.Container00; obj: ptr gtk.Widget00)",
    "set_focus_child!gtk.Container!1!(self: gtk.Container; obj: gtk.Widget)!(self: ptr gtk.Container00; obj: ptr gtk.Widget00)",
    ...
    "event!gtk.TextTag!3!(self: gtk.TextTag; obj: gobject.Object; event: gdk.Event; iter: gtk.TextIter): bool!(self: ptr gtk.TextTag00; obj: ptr gobject.Object00; event: ptr gdk.Event00; iter: gtk.TextIter): gboolean",
    ...
    "toggle_size_allocate!gtk.MenuItem!1!(self: gtk.MenuItem; obj: int)!(self: ptr gtk.MenuItem00; obj: int32)",
    "toggle_size_request!gtk.MenuItem!1!(self: gtk.MenuItem; obj: pointer)!(self: ptr gtk.MenuItem00; obj: pointer)",
    ...
    "create_context!gtk.GLArea!0!(self: gtk.GLArea): gdk.GLContext!(self: ptr gtk.GLArea00): ptr gdk.GLContext00",
    ...
    "move_cursor!gtk.ListBox!2!(self: gtk.ListBox; obj: gtk.MovementStep; p0: int)!(self: ptr gtk.ListBox00; obj: gtk.MovementStep; p0: int32)",
    ...
    "expand_collapse_cursor_row!gtk.TreeView!3!(self: gtk.TreeView; obj: bool; p0: bool; p1: bool): bool!(self: ptr gtk.TreeView00; obj: gboolean; p0: gboolean; p1: gboolean): gboolean",
    ...
    "select_cursor_row!gtk.TreeView!1!(self: gtk.TreeView; obj: bool): bool!(self: ptr gtk.TreeView00; obj: gboolean): gboolean",
    ...
    "move!gtk.HSV!1!(self: gtk.HSV; obj: gtk.DirectionType)!(self: ptr gtk.HSV00; obj: gtk.DirectionType)",
    "change_current_page!gtk.ShortcutsSection!1!(self: gtk.ShortcutsSection; obj: int): bool!(self: ptr gtk.ShortcutsSection00; obj: int32): gboolean",
    "change_current_page!gtk.Notebook!1!(self: gtk.Notebook; obj: int): bool!(self: ptr gtk.Notebook00; obj: int32): gboolean",
    "create_window!gtk.Notebook!3!(self: gtk.Notebook; page: gtk.Widget; x: int; y: int): Notebook!(self: ptr gtk.Notebook00; page: ptr gtk.Widget00; x: int32; y: int32): ptr Notebook00",
    "focus_tab!gtk.Notebook!1!(self: gtk.Notebook; obj: gtk.NotebookTab): bool!(self: ptr gtk.Notebook00; obj: gtk.NotebookTab): gboolean",
    "move_focus_out!gtk.Notebook!1!(self: gtk.Notebook; obj: gtk.DirectionType)!(self: ptr gtk.Notebook00; obj: gtk.DirectionType)",
    ...
    "reorder_tab!gtk.Notebook!2!(self: gtk.Notebook; obj: gtk.DirectionType; p0: bool): bool!(self: ptr gtk.Notebook00; obj: gtk.DirectionType; p0: gboolean): gboolean",
    "select_page!gtk.Notebook!1!(self: gtk.Notebook; obj: bool): bool!(self: ptr gtk.Notebook00; obj: gboolean): gboolean",
    ...
    "modifiers!gtk.EventControllerKey!1!(self: gtk.EventControllerKey; obj: gdk.ModifierType): bool!(self: ptr gtk.EventControllerKey00; obj: gdk.ModifierType): gboolean",
    ...
    "down!gtk.GestureStylus!2!(self: gtk.GestureStylus; obj: cdouble; p0: cdouble)!(self: ptr gtk.GestureStylus00; obj: cdouble; p0: cdouble)",
    "motion!gtk.GestureStylus!2!(self: gtk.GestureStylus; obj: cdouble; p0: cdouble)!(self: ptr gtk.GestureStylus00; obj: cdouble; p0: cdouble)",
    "proximity!gtk.GestureStylus!2!(self: gtk.GestureStylus; obj: cdouble; p0: cdouble)!(self: ptr gtk.GestureStylus00; obj: cdouble; p0: cdouble)",
    "up!gtk.GestureStylus!2!(self: gtk.GestureStylus; obj: cdouble; p0: cdouble)!(self: ptr gtk.GestureStylus00; obj: cdouble; p0: cdouble)",
    ...
    "create_custom_widget!gtk.PrintOperation!0!(self: gtk.PrintOperation): gobject.Object!(self: ptr gtk.PrintOperation00): ptr gobject.Object00",
    ...
    "create_surface!gdk.Window!2!(self: gdk.Window; width: int; height: int): cairo.Surface!(self: ptr gdk.Window00; width: int32; height: int32): ptr cairo.Surface00",
    ...
    "pick_embedded_child!gdk.Window!2!(self: gdk.Window; x: cdouble; y: cdouble): Window!(self: ptr gdk.Window00; x: cdouble; y: cdouble): ptr Window00",
    ...
    "setup_context_menu!vte.Terminal!1!(self: vte.Terminal; context: vte.EventContext = nil)!(self: ptr vte.Terminal00; context: ptr ptr vte.EventContext00)",
    "text_scrolled!vte.Terminal!1!(self: vte.Terminal; delta: int)!(self: ptr vte.Terminal00; delta: int32)",
    "page_changed!handy.Carousel!1!(self: handy.Carousel; index: int)!(self: ptr handy.Carousel00; index: uint32)",
    "child_switched!handy.Swipeable!2!(self: handy.Swipeable; index: int; duration: int64)!(self: ptr handy.Swipeable00; index: uint32; duration: int64)",
    "begin_swipe!handy.SwipeTracker!2!(self: handy.SwipeTracker; direction: handy.NavigationDirection; direct: bool)!(self: ptr handy.SwipeTracker00; direction: handy.NavigationDirection; direct: gboolean)",
    "end_swipe!handy.SwipeTracker!2!(self: handy.SwipeTracker; duration: int64; to: cdouble)!(self: ptr handy.SwipeTracker00; duration: int64; to: cdouble)",
    "update_swipe!handy.SwipeTracker!1!(self: handy.SwipeTracker; progress: cdouble)!(self: ptr handy.SwipeTracker00; progress: cdouble)",
    "extra_drag_data_received!handy.TabBar!5!(self: handy.TabBar; page: handy.TabPage; context: gdk.DragContext; data: gtk.SelectionData; info: int; time: int)!(self: ptr handy.TabBar00; page: ptr handy.TabPage00; context: ptr gdk.DragContext00; data: ptr gtk.SelectionData00; info: uint32; time: uint32)",
    "close_page!handy.TabView!1!(self: handy.TabView; page: handy.TabPage): bool!(self: ptr handy.TabView00; page: ptr handy.TabPage00): gboolean",
    "create_window!handy.TabView!0!(self: handy.TabView): TabView!(self: ptr handy.TabView00): ptr TabView00",
    "indicator_activated!handy.TabView!1!(self: handy.TabView; page: handy.TabPage)!(self: ptr handy.TabView00; page: ptr handy.TabPage00)",
    "page_attached!handy.TabView!2!(self: handy.TabView; page: handy.TabPage; position: int)!(self: ptr handy.TabView00; page: ptr handy.TabPage00; position: int32)",
    "page_detached!handy.TabView!2!(self: handy.TabView; page: handy.TabPage; position: int)!(self: ptr handy.TabView00; page: ptr handy.TabPage00; position: int32)",
    "page_reordered!handy.TabView!2!(self: handy.TabView; page: handy.TabPage; position: int)!(self: ptr handy.TabView00; page: ptr handy.TabPage00; position: int32)",
    "setup_menu!handy.TabView!1!(self: handy.TabView; page: handy.TabPage)!(self: ptr handy.TabView00; page: ptr handy.TabPage00)",
    ...
    "accept_certificate!soup.Message!2!(self: soup.Message; tlsPeerCertificate: gio.TlsCertificate; tlsPeerErrors: gio.TlsCertificateFlags): bool!(self: ptr soup.Message00; tlsPeerCertificate: ptr gio.TlsCertificate00; tlsPeerErrors: gio.TlsCertificateFlags): gboolean",
    "authenticate!soup.Message!2!(self: soup.Message; auth: soup.Auth; retrying: bool): bool!(self: ptr soup.Message00; auth: ptr soup.Auth00; retrying: gboolean): gboolean",
    ...
    "got_body_data!soup.Message!1!(self: soup.Message; chunkSize: int)!(self: ptr soup.Message00; chunkSize: uint32)",
    ...
    "request_certificate!soup.Message!1!(self: soup.Message; tlsConnection: gio.TlsClientConnection): bool!(self: ptr soup.Message00; tlsConnection: ptr gio.TlsClientConnection00): gboolean",
    "request_certificate_password!soup.Message!1!(self: soup.Message; tlsPassword: gio.TlsPassword): bool!(self: ptr soup.Message00; tlsPassword: ptr gio.TlsPassword00): gboolean",
    "wrote_body_data!soup.Message!1!(self: soup.Message; chunkSize: int)!(self: ptr soup.Message00; chunkSize: uint32)",
    "accept_certificate!soup.ServerMessage!2!(self: soup.ServerMessage; tlsPeerCertificate: gio.TlsCertificate; tlsPeerErrors: gio.TlsCertificateFlags): bool!(self: ptr soup.ServerMessage00; tlsPeerCertificate: ptr gio.TlsCertificate00; tlsPeerErrors: gio.TlsCertificateFlags): gboolean",
    "got_chunk!soup.ServerMessage!1!(self: soup.ServerMessage; chunk: glib.Bytes)!(self: ptr soup.ServerMessage00; chunk: ptr glib.Bytes00)",
    "wrote_body_data!soup.ServerMessage!1!(self: soup.ServerMessage; chunkSize: int)!(self: ptr soup.ServerMessage00; chunkSize: uint32)",
    ...
    "request_aborted!soup.Server!1!(self: soup.Server; message: soup.ServerMessage)!(self: ptr soup.Server00; message: ptr soup.ServerMessage00)",
    "request_finished!soup.Server!1!(self: soup.Server; message: soup.ServerMessage)!(self: ptr soup.Server00; message: ptr soup.ServerMessage00)",
    "request_read!soup.Server!1!(self: soup.Server; message: soup.ServerMessage)!(self: ptr soup.Server00; message: ptr soup.ServerMessage00)",
    "request_started!soup.Server!1!(self: soup.Server; message: soup.ServerMessage)!(self: ptr soup.Server00; message: ptr soup.ServerMessage00)",
    ...
    "create_custom_widget!webkit2.PrintOperation!0!(self: webkit2.PrintOperation): PrintCustomWidget!(self: ptr webkit2.PrintOperation00): ptr PrintCustomWidget00",
    ...
    "create!webkit2.WebView!1!(self: webkit2.WebView; navigationAction: webkit2.NavigationAction): gtk.Widget!(self: ptr webkit2.WebView00; navigationAction: ptr webkit2.NavigationAction00): ptr gtk.Widget00",
    ...
    "query_permission_state!webkit2.WebView!1!(self: webkit2.WebView; query: webkit2.PermissionStateQuery): bool!(self: ptr webkit2.WebView00; query: ptr webkit2.PermissionStateQuery00): gboolean",
    ...
    "create_web_view!webkit2.AutomationSession!0!(self: webkit2.AutomationSession): WebView!(self: ptr webkit2.AutomationSession00): ptr WebView00",
    ...
    "script_message_received!webkit2.UserContentManager!1!(self: webkit2.UserContentManager; value: webkit2.JavascriptResult)!(self: ptr webkit2.UserContentManager00; value: ptr webkit2.JavascriptResult00)",
    "script_message_with_reply_received!webkit2.UserContentManager!2!(self: webkit2.UserContentManager; value: javascriptcore.Value; reply: webkit2.ScriptMessageReply): bool!(self: ptr webkit2.UserContentManager00; value: ptr javascriptcore.Value00; reply: ptr webkit2.ScriptMessageReply00): gboolean",
    ...
    "form_controls_associated!webkit2webextension.WebFormManager!2!(self: webkit2webextension.WebFormManager; frame: webkit2webextension.Frame; elements: PtrArray00Array)!(self: ptr webkit2webextension.WebFormManager00; frame: ptr webkit2webextension.Frame00; elements: PtrArray00Array)",
    "will_send_submit_event!webkit2webextension.WebFormManager!3!(self: webkit2webextension.WebFormManager; form: javascriptcore.Value; sourceFrame: webkit2webextension.Frame; targetFrame: webkit2webextension.Frame)!(self: ptr webkit2webextension.WebFormManager00; form: ptr javascriptcore.Value00; sourceFrame: ptr webkit2webextension.Frame00; targetFrame: ptr webkit2webextension.Frame00)",
    "will_submit_form!webkit2webextension.WebFormManager!3!(self: webkit2webextension.WebFormManager; form: javascriptcore.Value; sourceFrame: webkit2webextension.Frame; targetFrame: webkit2webextension.Frame)!(self: ptr webkit2webextension.WebFormManager00; form: ptr javascriptcore.Value00; sourceFrame: ptr webkit2webextension.Frame00; targetFrame: ptr webkit2webextension.Frame00)",
