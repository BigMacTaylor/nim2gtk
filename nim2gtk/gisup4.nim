const
  SCA = [
    ...
    "provider_added!gtksource5.Completion!1!(self: gtksource5.Completion; provider: gtksource5.CompletionProvider)!(self: ptr gtksource5.Completion00; provider: ptr gtksource5.CompletionProvider00)",
    "provider_removed!gtksource5.Completion!1!(self: gtksource5.Completion; provider: gtksource5.CompletionProvider)!(self: ptr gtksource5.Completion00; provider: ptr gtksource5.CompletionProvider00)",
    "provider_model_changed!gtksource5.CompletionContext!2!(self: gtksource5.CompletionContext; provider: gtksource5.CompletionProvider; model: gio.ListModel = nil)!(self: ptr gtksource5.CompletionContext00; provider: ptr gtksource5.CompletionProvider00; model: ptr gio.ListModel00)",
    ...
    "line_mark_activated!gtksource5.View!4!(self: gtksource5.View; iter: gtk4.TextIter; button: int; state: gdk4.ModifierType; nPresses: int)!(self: ptr gtksource5.View00; iter: gtk4.TextIter; button: uint32; state: gdk4.ModifierType; nPresses: int32)",
    ...
    "push_snippet!gtksource5.View!2!(self: gtksource5.View; snippet: gtksource5.Snippet; location: var gtk4.TextIter)!(self: ptr gtksource5.View00; snippet: ptr gtksource5.Snippet00; location: var gtk4.TextIter)",
    ...
    "activate!gtksource5.GutterRenderer!5!(self: gtksource5.GutterRenderer; iter: gtk4.TextIter; area: gdk4.Rectangle; button: int; state: gdk4.ModifierType; nPresses: int)!(self: ptr gtksource5.GutterRenderer00; iter: gtk4.TextIter; area: gdk4.Rectangle; button: uint32; state: gdk4.ModifierType; nPresses: int32)",
    "query_activatable!gtksource5.GutterRenderer!2!(self: gtksource5.GutterRenderer; iter: gtk4.TextIter; area: gdk4.Rectangle): bool!(self: ptr gtksource5.GutterRenderer00; iter: gtk4.TextIter; area: gdk4.Rectangle): gboolean",
    "query_data!gtksource5.GutterRenderer!2!(self: gtksource5.GutterRenderer; obj: gobject.Object; p0: int)!(self: ptr gtksource5.GutterRenderer00; obj: ptr gobject.Object00; p0: uint32)",
    ...
    "edit!gtksource5.VimIMContext!2!(self: gtksource5.VimIMContext; view: gtksource5.View; path: cstring = nil)!(self: ptr gtksource5.VimIMContext00; view: ptr gtksource5.View00; path: cstring)",
    "execute_command!gtksource5.VimIMContext!1!(self: gtksource5.VimIMContext; command: cstring): bool!(self: ptr gtksource5.VimIMContext00; command: cstring): gboolean",
    "format_text!gtksource5.VimIMContext!2!(self: gtksource5.VimIMContext; begin: gtk4.TextIter; `end`: gtk4.TextIter)!(self: ptr gtksource5.VimIMContext00; begin: gtk4.TextIter; `end`: gtk4.TextIter)",
    "write!gtksource5.VimIMContext!2!(self: gtksource5.VimIMContext; view: gtksource5.View; path: cstring = nil)!(self: ptr gtksource5.VimIMContext00; view: ptr gtksource5.View00; path: cstring)",
    ...
    "action_invoked!gupnp.Service!1!(self: gupnp.Service; action: gupnp.ServiceAction)!(self: ptr gupnp.Service00; action: ptr gupnp.ServiceAction00)",
    "notify_failed!gupnp.Service!2!(self: gupnp.Service; callbackUrl: seq[glib.Uri]; reason: ptr glib.Error)!(self: ptr gupnp.Service00; callbackUrl: glib.Uri00; reason: ptr glib.Error)",
    "query_variable!gupnp.Service!2!(self: gupnp.Service; variable: cstring; value: var gobject.Value)!(self: ptr gupnp.Service00; variable: cstring; value: var gobject.Value)",
    "context_available!gupnp.ContextManager!1!(self: gupnp.ContextManager; context: gupnp.Context)!(self: ptr gupnp.ContextManager00; context: ptr gupnp.Context00)",
    "context_unavailable!gupnp.ContextManager!1!(self: gupnp.ContextManager; context: gupnp.Context)!(self: ptr gupnp.ContextManager00; context: ptr gupnp.Context00)",
    "subscription_lost!gupnp.ServiceProxy!1!(self: gupnp.ServiceProxy; error: ptr glib.Error)!(self: ptr gupnp.ServiceProxy00; error: ptr glib.Error)",
    "device_proxy_available!gupnp.ControlPoint!1!(self: gupnp.ControlPoint; proxy: gupnp.DeviceProxy)!(self: ptr gupnp.ControlPoint00; proxy: ptr gupnp.DeviceProxy00)",
    "device_proxy_unavailable!gupnp.ControlPoint!1!(self: gupnp.ControlPoint; proxy: gupnp.DeviceProxy)!(self: ptr gupnp.ControlPoint00; proxy: ptr gupnp.DeviceProxy00)",
    "service_proxy_available!gupnp.ControlPoint!1!(self: gupnp.ControlPoint; proxy: gupnp.ServiceProxy)!(self: ptr gupnp.ControlPoint00; proxy: ptr gupnp.ServiceProxy00)",
    "service_proxy_unavailable!gupnp.ControlPoint!1!(self: gupnp.ControlPoint; proxy: gupnp.ServiceProxy)!(self: ptr gupnp.ControlPoint00; proxy: ptr gupnp.ServiceProxy00)",
    "candidate_gathering_done!nice.Agent!1!(self: nice.Agent; streamId: int)!(self: ptr nice.Agent00; streamId: uint32)",
    "component_state_changed!nice.Agent!3!(self: nice.Agent; streamId: int; componentId: int; state: int)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32; state: uint32)",
    "initial_binding_request_received!nice.Agent!1!(self: nice.Agent; streamId: int)!(self: ptr nice.Agent00; streamId: uint32)",
    "new_candidate!nice.Agent!3!(self: nice.Agent; streamId: int; componentId: int; foundation: cstring)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32; foundation: cstring)",
    "new_candidate_full!nice.Agent!1!(self: nice.Agent; candidate: nice.Candidate)!(self: ptr nice.Agent00; candidate: ptr nice.Candidate00)",
    "new_remote_candidate!nice.Agent!3!(self: nice.Agent; streamId: int; componentId: int; foundation: cstring)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32; foundation: cstring)",
    "new_remote_candidate_full!nice.Agent!1!(self: nice.Agent; candidate: nice.Candidate)!(self: ptr nice.Agent00; candidate: ptr nice.Candidate00)",
    "new_selected_pair!nice.Agent!4!(self: nice.Agent; streamId: int; componentId: int; lfoundation: cstring; rfoundation: cstring)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32; lfoundation: cstring; rfoundation: cstring)",
    "new_selected_pair_full!nice.Agent!4!(self: nice.Agent; streamId: int; componentId: int; lcandidate: nice.Candidate; rcandidate: nice.Candidate)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32; lcandidate: ptr nice.Candidate00; rcandidate: ptr nice.Candidate00)",
    "reliable_transport_writable!nice.Agent!2!(self: nice.Agent; streamId: int; componentId: int)!(self: ptr nice.Agent00; streamId: uint32; componentId: uint32)",
    "streams_removed!nice.Agent!1!(self: nice.Agent; streamIds: seq[uint32])!(self: ptr nice.Agent00; streamIds: uint32Array)",
    ...
    "authenticated!webkit6.AuthenticationRequest!1!(self: webkit6.AuthenticationRequest; credential: webkit6.Credential)!(self: ptr webkit6.AuthenticationRequest00; credential: ptr webkit6.Credential00)",
    "failed!webkit6.PrintOperation!1!(self: webkit6.PrintOperation; error: ptr glib.Error)!(self: ptr webkit6.PrintOperation00; error: ptr glib.Error)",
    "failed!webkit6.WebResource!1!(self: webkit6.WebResource; error: ptr glib.Error)!(self: ptr webkit6.WebResource00; error: ptr glib.Error)",
    "failed_with_tls_errors!webkit6.WebResource!2!(self: webkit6.WebResource; certificate: gio.TlsCertificate; errors: gio.TlsCertificateFlags)!(self: ptr webkit6.WebResource00; certificate: ptr gio.TlsCertificate00; errors: gio.TlsCertificateFlags)",
    "sent_request!webkit6.WebResource!2!(self: webkit6.WebResource; request: webkit6.URIRequest; redirectedResponse: webkit6.URIResponse)!(self: ptr webkit6.WebResource00; request: ptr webkit6.URIRequest00; redirectedResponse: ptr webkit6.URIResponse00)",
    "authenticate!webkit6.WebView!1!(self: webkit6.WebView; request: webkit6.AuthenticationRequest): bool!(self: ptr webkit6.WebView00; request: ptr webkit6.AuthenticationRequest00): gboolean",
    "context_menu!webkit6.WebView!2!(self: webkit6.WebView; contextMenu: webkit6.ContextMenu; hitTestResult: webkit6.HitTestResult): bool!(self: ptr webkit6.WebView00; contextMenu: ptr webkit6.ContextMenu00; hitTestResult: ptr webkit6.HitTestResult00): gboolean",
    "create!webkit6.WebView!1!(self: webkit6.WebView; navigationAction: webkit6.NavigationAction): gtk4.Widget!(self: ptr webkit6.WebView00; navigationAction: ptr webkit6.NavigationAction00): ptr gtk4.Widget00",
    "decide_policy!webkit6.WebView!2!(self: webkit6.WebView; decision: webkit6.PolicyDecision; decisionType: webkit6.PolicyDecisionType): bool!(self: ptr webkit6.WebView00; decision: ptr webkit6.PolicyDecision00; decisionType: webkit6.PolicyDecisionType): gboolean",
    "enter_fullscreen!webkit6.WebView!0!(self: webkit6.WebView): bool!(self: ptr webkit6.WebView00): gboolean",
    "insecure_content_detected!webkit6.WebView!1!(self: webkit6.WebView; event: webkit6.InsecureContentEvent)!(self: ptr webkit6.WebView00; event: webkit6.InsecureContentEvent)",
    "leave_fullscreen!webkit6.WebView!0!(self: webkit6.WebView): bool!(self: ptr webkit6.WebView00): gboolean",
    "load_changed!webkit6.WebView!1!(self: webkit6.WebView; loadEvent: webkit6.LoadEvent)!(self: ptr webkit6.WebView00; loadEvent: webkit6.LoadEvent)",
    "load_failed!webkit6.WebView!3!(self: webkit6.WebView; loadEvent: webkit6.LoadEvent; failingUri: cstring; error: ptr glib.Error): bool!(self: ptr webkit6.WebView00; loadEvent: webkit6.LoadEvent; failingUri: cstring; error: ptr glib.Error): gboolean",
    "load_failed_with_tls_errors!webkit6.WebView!3!(self: webkit6.WebView; failingUri: cstring; certificate: gio.TlsCertificate; errors: gio.TlsCertificateFlags): bool!(self: ptr webkit6.WebView00; failingUri: cstring; certificate: ptr gio.TlsCertificate00; errors: gio.TlsCertificateFlags): gboolean",
    "mouse_target_changed!webkit6.WebView!2!(self: webkit6.WebView; hitTestResult: webkit6.HitTestResult; modifiers: int)!(self: ptr webkit6.WebView00; hitTestResult: ptr webkit6.HitTestResult00; modifiers: uint32)",
    "permission_request!webkit6.WebView!1!(self: webkit6.WebView; request: webkit6.PermissionRequest): bool!(self: ptr webkit6.WebView00; request: ptr webkit6.PermissionRequest00): gboolean",
    "print!webkit6.WebView!1!(self: webkit6.WebView; printOperation: webkit6.PrintOperation): bool!(self: ptr webkit6.WebView00; printOperation: ptr webkit6.PrintOperation00): gboolean",
    "query_permission_state!webkit6.WebView!1!(self: webkit6.WebView; query: webkit6.PermissionStateQuery): bool!(self: ptr webkit6.WebView00; query: ptr webkit6.PermissionStateQuery00): gboolean",
    "resource_load_started!webkit6.WebView!2!(self: webkit6.WebView; resource: webkit6.WebResource; request: webkit6.URIRequest)!(self: ptr webkit6.WebView00; resource: ptr webkit6.WebResource00; request: ptr webkit6.URIRequest00)",
    "run_color_chooser!webkit6.WebView!1!(self: webkit6.WebView; request: webkit6.ColorChooserRequest): bool!(self: ptr webkit6.WebView00; request: ptr webkit6.ColorChooserRequest00): gboolean",
    "run_file_chooser!webkit6.WebView!1!(self: webkit6.WebView; request: webkit6.FileChooserRequest): bool!(self: ptr webkit6.WebView00; request: ptr webkit6.FileChooserRequest00): gboolean",
    "script_dialog!webkit6.WebView!1!(self: webkit6.WebView; dialog: webkit6.ScriptDialog): bool!(self: ptr webkit6.WebView00; dialog: ptr webkit6.ScriptDialog00): gboolean",
    "show_notification!webkit6.WebView!1!(self: webkit6.WebView; notification: webkit6.Notification): bool!(self: ptr webkit6.WebView00; notification: ptr webkit6.Notification00): gboolean",
    "show_option_menu!webkit6.WebView!2!(self: webkit6.WebView; menu: webkit6.OptionMenu; rectangle: gdk4.Rectangle): bool!(self: ptr webkit6.WebView00; menu: ptr webkit6.OptionMenu00; rectangle: gdk4.Rectangle): gboolean",
    "submit_form!webkit6.WebView!1!(self: webkit6.WebView; request: webkit6.FormSubmissionRequest)!(self: ptr webkit6.WebView00; request: ptr webkit6.FormSubmissionRequest00)",
    "user_message_received!webkit6.WebView!1!(self: webkit6.WebView; message: webkit6.UserMessage): bool!(self: ptr webkit6.WebView00; message: ptr webkit6.UserMessage00): gboolean",
    "web_process_terminated!webkit6.WebView!1!(self: webkit6.WebView; reason: webkit6.WebProcessTerminationReason)!(self: ptr webkit6.WebView00; reason: webkit6.WebProcessTerminationReason)",
    "create_web_view!webkit6.AutomationSession!0!(self: webkit6.AutomationSession): WebView!(self: ptr webkit6.AutomationSession00): ptr WebView00",
    "created_destination!webkit6.Download!1!(self: webkit6.Download; destination: cstring)!(self: ptr webkit6.Download00; destination: cstring)",
    "decide_destination!webkit6.Download!1!(self: webkit6.Download; suggestedFilename: cstring): bool!(self: ptr webkit6.Download00; suggestedFilename: cstring): gboolean",
    "failed!webkit6.Download!1!(self: webkit6.Download; error: ptr glib.Error)!(self: ptr webkit6.Download00; error: ptr glib.Error)",
    "received_data!webkit6.Download!1!(self: webkit6.Download; dataLength: uint64)!(self: ptr webkit6.Download00; dataLength: uint64)",
    "automation_started!webkit6.WebContext!1!(self: webkit6.WebContext; session: webkit6.AutomationSession)!(self: ptr webkit6.WebContext00; session: ptr webkit6.AutomationSession00)",
    "user_message_received!webkit6.WebContext!1!(self: webkit6.WebContext; message: webkit6.UserMessage): bool!(self: ptr webkit6.WebContext00; message: ptr webkit6.UserMessage00): gboolean",
    "start!webkit6.GeolocationManager!0!(self: webkit6.GeolocationManager): bool!(self: ptr webkit6.GeolocationManager00): gboolean",
    "counted_matches!webkit6.FindController!1!(self: webkit6.FindController; matchCount: int)!(self: ptr webkit6.FindController00; matchCount: uint32)",
    "found_text!webkit6.FindController!1!(self: webkit6.FindController; matchCount: int)!(self: ptr webkit6.FindController00; matchCount: uint32)",
    "attach!webkit6.WebInspector!0!(self: webkit6.WebInspector): bool!(self: ptr webkit6.WebInspector00): gboolean",
    "bring_to_front!webkit6.WebInspector!0!(self: webkit6.WebInspector): bool!(self: ptr webkit6.WebInspector00): gboolean",
    "detach!webkit6.WebInspector!0!(self: webkit6.WebInspector): bool!(self: ptr webkit6.WebInspector00): gboolean",
    "open_window!webkit6.WebInspector!0!(self: webkit6.WebInspector): bool!(self: ptr webkit6.WebInspector00): gboolean",
    "download_started!webkit6.NetworkSession!1!(self: webkit6.NetworkSession; download: webkit6.Download)!(self: ptr webkit6.NetworkSession00; download: ptr webkit6.Download00)",
    "favicon_changed!webkit6.FaviconDatabase!2!(self: webkit6.FaviconDatabase; pageUri: cstring; faviconUri: cstring)!(self: ptr webkit6.FaviconDatabase00; pageUri: cstring; faviconUri: cstring)",
    "script_message_received!webkit6.UserContentManager!1!(self: webkit6.UserContentManager; value: javascriptcore6.Value)!(self: ptr webkit6.UserContentManager00; value: ptr javascriptcore6.Value00)",
    "script_message_with_reply_received!webkit6.UserContentManager!2!(self: webkit6.UserContentManager; value: javascriptcore6.Value; reply: webkit6.ScriptMessageReply): bool!(self: ptr webkit6.UserContentManager00; value: ptr javascriptcore6.Value00; reply: ptr webkit6.ScriptMessageReply00): gboolean",
    "changed!webkit6.BackForwardList!2!(self: webkit6.BackForwardList; itemAdded: webkit6.BackForwardListItem = nil; itemsRemoved: pointer)!(self: ptr webkit6.BackForwardList00; itemAdded: ptr webkit6.BackForwardListItem00; itemsRemoved: pointer)",
    "committed!webkit6.InputMethodContext!1!(self: webkit6.InputMethodContext; text: cstring)!(self: ptr webkit6.InputMethodContext00; text: cstring)",
    "delete_surrounding!webkit6.InputMethodContext!2!(self: webkit6.InputMethodContext; offset: int; nChars: int)!(self: ptr webkit6.InputMethodContext00; offset: int32; nChars: uint32)",
    ...
    "append!gstinsertbin.InsertBin!3!(self: gstinsertbin.InsertBin; callback: gst.Element; userData: pointer; userData2: pointer)!(self: ptr gstinsertbin.InsertBin00; callback: ptr gst.Element00; userData: pointer; userData2: pointer)",
    "insert_after!gstinsertbin.InsertBin!4!(self: gstinsertbin.InsertBin; sibling: gst.Element; callback: gst.Element; userData: pointer; userData2: pointer)!(self: ptr gstinsertbin.InsertBin00; sibling: ptr gst.Element00; callback: ptr gst.Element00; userData: pointer; userData2: pointer)",
    "insert_before!gstinsertbin.InsertBin!4!(self: gstinsertbin.InsertBin; sibling: gst.Element; callback: gst.Element; userData: pointer; userData2: pointer)!(self: ptr gstinsertbin.InsertBin00; sibling: ptr gst.Element00; callback: ptr gst.Element00; userData: pointer; userData2: pointer)",
    "prepend!gstinsertbin.InsertBin!3!(self: gstinsertbin.InsertBin; callback: gst.Element; userData: pointer; userData2: pointer)!(self: ptr gstinsertbin.InsertBin00; callback: ptr gst.Element00; userData: pointer; userData2: pointer)",
    "remove!gstinsertbin.InsertBin!3!(self: gstinsertbin.InsertBin; callback: gst.Element; userData: pointer; userData2: pointer)!(self: ptr gstinsertbin.InsertBin00; callback: ptr gst.Element00; userData: pointer; userData2: pointer)",
    "buffering!gstplayer.Player!1!(self: gstplayer.Player; obj: int)!(self: ptr gstplayer.Player00; obj: int32)",
    "duration_changed!gstplayer.Player!1!(self: gstplayer.Player; obj: uint64)!(self: ptr gstplayer.Player00; obj: uint64)",
    "error!gstplayer.Player!1!(self: gstplayer.Player; obj: ptr glib.Error)!(self: ptr gstplayer.Player00; obj: ptr glib.Error)",
    "media_info_updated!gstplayer.Player!1!(self: gstplayer.Player; obj: gstplayer.PlayerMediaInfo)!(self: ptr gstplayer.Player00; obj: ptr gstplayer.PlayerMediaInfo00)",
    "position_updated!gstplayer.Player!1!(self: gstplayer.Player; obj: uint64)!(self: ptr gstplayer.Player00; obj: uint64)",
    "seek_done!gstplayer.Player!1!(self: gstplayer.Player; obj: uint64)!(self: ptr gstplayer.Player00; obj: uint64)",
    "state_changed!gstplayer.Player!1!(self: gstplayer.Player; obj: gstplayer.PlayerState)!(self: ptr gstplayer.Player00; obj: gstplayer.PlayerState)",
    "uri_loaded!gstplayer.Player!1!(self: gstplayer.Player; obj: cstring)!(self: ptr gstplayer.Player00; obj: cstring)",
    "video_dimensions_changed!gstplayer.Player!2!(self: gstplayer.Player; obj: int; p0: int)!(self: ptr gstplayer.Player00; obj: int32; p0: int32)",
    "warning!gstplayer.Player!1!(self: gstplayer.Player; obj: ptr glib.Error)!(self: ptr gstplayer.Player00; obj: ptr glib.Error)",
    ...
    "on_error!gstwebrtc.WebRTCDataChannel!1!(self: gstwebrtc.WebRTCDataChannel; error: ptr glib.Error)!(self: ptr gstwebrtc.WebRTCDataChannel00; error: ptr glib.Error)",
    "on_message_data!gstwebrtc.WebRTCDataChannel!1!(self: gstwebrtc.WebRTCDataChannel; data: glib.Bytes = nil)!(self: ptr gstwebrtc.WebRTCDataChannel00; data: ptr glib.Bytes00)",
    "on_message_string!gstwebrtc.WebRTCDataChannel!1!(self: gstwebrtc.WebRTCDataChannel; data: cstring = nil)!(self: ptr gstwebrtc.WebRTCDataChannel00; data: cstring)",
    "send_data!gstwebrtc.WebRTCDataChannel!1!(self: gstwebrtc.WebRTCDataChannel; data: glib.Bytes = nil)!(self: ptr gstwebrtc.WebRTCDataChannel00; data: ptr glib.Bytes00)",
    "send_string!gstwebrtc.WebRTCDataChannel!1!(self: gstwebrtc.WebRTCDataChannel; data: cstring = nil)!(self: ptr gstwebrtc.WebRTCDataChannel00; data: cstring)",
    "add_local_ip_address!gstwebrtc.WebRTCICE!1!(self: gstwebrtc.WebRTCICE; address: cstring): bool!(self: ptr gstwebrtc.WebRTCICE00; address: cstring): gboolean",
    "on_new_candidate!gstwebrtc.WebRTCICETransport!1!(self: gstwebrtc.WebRTCICETransport; obj: cstring)!(self: ptr gstwebrtc.WebRTCICETransport00; obj: cstring)",
    "new_preroll!gstapp.AppSink!0!(self: gstapp.AppSink): gst.FlowReturn!(self: ptr gstapp.AppSink00): gst.FlowReturn",
    "new_sample!gstapp.AppSink!0!(self: gstapp.AppSink): gst.FlowReturn!(self: ptr gstapp.AppSink00): gst.FlowReturn",
    "new_serialized_event!gstapp.AppSink!0!(self: gstapp.AppSink): bool!(self: ptr gstapp.AppSink00): gboolean",
    "propose_allocation!gstapp.AppSink!1!(self: gstapp.AppSink; query: gst.Query): bool!(self: ptr gstapp.AppSink00; query: ptr gst.Query00): gboolean",
