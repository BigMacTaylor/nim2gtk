...
proc webkit_navigation_action_get_frame_name(self: ptr NavigationAction00): cstring {.
    importc, libprag.}

proc getFrameName*(self: NavigationAction): string =
  let resul0 = webkit_navigation_action_get_frame_name(cast[ptr NavigationAction00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc frameName*(self: NavigationAction): string =
  let resul0 = webkit_navigation_action_get_frame_name(cast[ptr NavigationAction00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
type
  ...
  PermissionStateQuery* = ref object
    impl*: ptr PermissionStateQuery00
    ignoreFinalizer*: bool

proc webkit_permission_state_query_get_type*(): GType {.importc, libprag.}

proc gBoxedFreeWebKitPermissionStateQuery*(self: PermissionStateQuery) =
  if not self.ignoreFinalizer:
    boxedFree(webkit_permission_state_query_get_type(), cast[ptr PermissionStateQuery00](self.impl))

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(PermissionStateQuery()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    if not self.ignoreFinalizer and self.impl != nil:
      boxedFree(webkit_permission_state_query_get_type(), cast[ptr PermissionStateQuery00](self.impl))
...
proc newWithFinalizer*(x: var PermissionStateQuery) =
  when defined(gcDestructors):
    new(x)
  else:
    new(x, gBoxedFreeWebKitPermissionStateQuery)

proc webkit_permission_state_query_unref(self: ptr PermissionStateQuery00) {.
    importc, libprag.}

proc unref*(self: PermissionStateQuery) =
  webkit_permission_state_query_unref(cast[ptr PermissionStateQuery00](self.impl))

proc finalizerunref*(self: PermissionStateQuery) =
  if not self.ignoreFinalizer:
    webkit_permission_state_query_unref(cast[ptr PermissionStateQuery00](self.impl))

proc webkit_permission_state_query_get_name(self: ptr PermissionStateQuery00): cstring {.
    importc, libprag.}

proc getName*(self: PermissionStateQuery): string =
  result = $webkit_permission_state_query_get_name(cast[ptr PermissionStateQuery00](self.impl))

proc name*(self: PermissionStateQuery): string =
  result = $webkit_permission_state_query_get_name(cast[ptr PermissionStateQuery00](self.impl))

proc webkit_permission_state_query_get_security_origin(self: ptr PermissionStateQuery00): ptr SecurityOrigin00 {.
    importc, libprag.}

proc getSecurityOrigin*(self: PermissionStateQuery): SecurityOrigin =
  fnew(result, gBoxedFreeWebKitSecurityOrigin)
  result.impl = webkit_permission_state_query_get_security_origin(cast[ptr PermissionStateQuery00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(webkit_security_origin_get_type(), result.impl))

proc securityOrigin*(self: PermissionStateQuery): SecurityOrigin =
  fnew(result, gBoxedFreeWebKitSecurityOrigin)
  result.impl = webkit_permission_state_query_get_security_origin(cast[ptr PermissionStateQuery00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(webkit_security_origin_get_type(), result.impl))

proc webkit_permission_state_query_ref(self: ptr PermissionStateQuery00): ptr PermissionStateQuery00 {.
    importc, libprag.}

proc `ref`*(self: PermissionStateQuery): PermissionStateQuery =
  fnew(result, gBoxedFreeWebKitPermissionStateQuery)
  result.impl = webkit_permission_state_query_ref(cast[ptr PermissionStateQuery00](self.impl))

type
  PermissionState* {.size: sizeof(cint), pure.} = enum
    granted = 0
    denied = 1
    prompt = 2

proc webkit_permission_state_query_finish(self: ptr PermissionStateQuery00;
    state: PermissionState) {.
    importc, libprag.}

proc finish*(self: PermissionStateQuery; state: PermissionState) =
  webkit_permission_state_query_finish(cast[ptr PermissionStateQuery00](self.impl), state)
...
type
  ClipboardPermissionRequest* = ref object of gobject.Object
  ClipboardPermissionRequest00* = object of gobject.Object00

proc webkit_clipboard_permission_request_get_type*(): GType {.importc, libprag.}

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(ClipboardPermissionRequest()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    g_object_set_qdata(self.impl, Quark, nil)
    if not self.ignoreFinalizer and self.impl != nil:
...
proc webkit_uri_request_get_http_headers(self: ptr URIRequest00): ptr soup3.MessageHeaders00 {.
    importc, libprag.}

proc getHttpHeaders*(self: URIRequest): soup3.MessageHeaders =
...
proc httpHeaders*(self: URIRequest): soup3.MessageHeaders =
  fnew(result, gBoxedFreeSoupMessageHeaders)
  result.impl = webkit_uri_request_get_http_headers(cast[ptr URIRequest00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(soup_message_headers_get_type(), result.impl))
...
proc webkit_uri_response_get_http_headers(self: ptr URIResponse00): ptr soup3.MessageHeaders00 {.
    importc, libprag.}

proc getHttpHeaders*(self: URIResponse): soup3.MessageHeaders =
  fnew(result, gBoxedFreeSoupMessageHeaders)
  result.impl = webkit_uri_response_get_http_headers(cast[ptr URIResponse00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(soup_message_headers_get_type(), result.impl))

proc httpHeaders*(self: URIResponse): soup3.MessageHeaders =
  fnew(result, gBoxedFreeSoupMessageHeaders)
  result.impl = webkit_uri_response_get_http_headers(cast[ptr URIResponse00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(soup_message_headers_get_type(), result.impl))
...
proc scQueryPermissionState*(self: WebView;  p: proc (self: ptr WebView00; query: ptr PermissionStateQuery00; xdata: pointer): gboolean {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "query-permission-state", cast[GCallback](p), xdata, nil, cf)
...
proc webkit_web_view_call_async_javascript_function(self: ptr WebView00;
    body: cstring; length: int64; arguments: ptr glib.Variant00; worldName: cstring;
    sourceUri: cstring; cancellable: ptr gio.Cancellable00; callback: AsyncReadyCallback;
    userData: pointer) {.
    importc, libprag.}

proc callAsyncJavascriptFunction*(self: WebView; body: cstring;
    length: int64; arguments: glib.Variant = nil; worldName: cstring = nil;
    sourceUri: cstring = nil; cancellable: gio.Cancellable = nil; callback: AsyncReadyCallback;
    userData: pointer) =
...
proc webkit_web_view_evaluate_javascript(self: ptr WebView00; script: cstring;
    length: int64; worldName: cstring; sourceUri: cstring; cancellable: ptr gio.Cancellable00;
    callback: AsyncReadyCallback; userData: pointer) {.
    importc, libprag.}

proc evaluateJavascript*(self: WebView; script: cstring;
    length: int64; worldName: cstring = nil; sourceUri: cstring = nil; cancellable: gio.Cancellable = nil;
    callback: AsyncReadyCallback; userData: pointer) =
...
proc webkit_web_view_get_default_content_security_policy(self: ptr WebView00): cstring {.
    importc, libprag.}

proc getDefaultContentSecurityPolicy*(self: WebView): string =
  let resul0 = webkit_web_view_get_default_content_security_policy(cast[ptr WebView00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc defaultContentSecurityPolicy*(self: WebView): string =
  let resul0 = webkit_web_view_get_default_content_security_policy(cast[ptr WebView00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc scCreateWebView*(self: AutomationSession;  p: proc (self: ptr AutomationSession00; xdata: pointer): ptr WebView00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "create-web-view", cast[GCallback](p), xdata, nil, cf)

proc scWillClose*(self: AutomationSession;  p: proc (self: ptr gobject.Object00; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "will-close", cast[GCallback](p), xdata, nil, cf)
...
proc getDestination*(self: Download): string =
  let resul0 = webkit_download_get_destination(cast[ptr Download00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc webkit_download_set_destination(self: ptr Download00; destination: cstring) {.
    importc, libprag.}

proc setDestination*(self: Download; destination: cstring) =
  webkit_download_set_destination(cast[ptr Download00](self.impl), destination)

proc `destination=`*(self: Download; destination: cstring) =
  webkit_download_set_destination(cast[ptr Download00](self.impl), destination)
...
proc webkit_web_context_get_time_zone_override(self: ptr WebContext00): cstring {.
    importc, libprag.}

proc getTimeZoneOverride*(self: WebContext): string =
...
proc scChanged*(self: EditorState;  p: proc (self: ptr gobject.Object00; xdata: pointer) {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
...
type
  ...
  ScriptMessageReply* = ref object
    impl*: ptr ScriptMessageReply00
    ignoreFinalizer*: bool

proc webkit_script_message_reply_get_type*(): GType {.importc, libprag.}

proc gBoxedFreeWebKitScriptMessageReply*(self: ScriptMessageReply) =
  if not self.ignoreFinalizer:
    boxedFree(webkit_script_message_reply_get_type(), cast[ptr ScriptMessageReply00](self.impl))

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(ScriptMessageReply()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    if not self.ignoreFinalizer and self.impl != nil:
      boxedFree(webkit_script_message_reply_get_type(), cast[ptr ScriptMessageReply00](self.impl))
...
proc newWithFinalizer*(x: var ScriptMessageReply) =
  when defined(gcDestructors):
    new(x)
  else:
    new(x, gBoxedFreeWebKitScriptMessageReply)

proc webkit_script_message_reply_unref(self: ptr ScriptMessageReply00) {.
    importc, libprag.}

proc unref*(self: ScriptMessageReply) =
  webkit_script_message_reply_unref(cast[ptr ScriptMessageReply00](self.impl))

proc finalizerunref*(self: ScriptMessageReply) =
  if not self.ignoreFinalizer:
    webkit_script_message_reply_unref(cast[ptr ScriptMessageReply00](self.impl))

proc webkit_script_message_reply_return_error_message(self: ptr ScriptMessageReply00;
    errorMessage: cstring) {.
    importc, libprag.}

proc returnErrorMessage*(self: ScriptMessageReply;
    errorMessage: cstring) =
...
proc `ref`*(self: ScriptMessageReply): ScriptMessageReply =
  fnew(result, gBoxedFreeWebKitScriptMessageReply)
  result.impl = webkit_script_message_reply_ref(cast[ptr ScriptMessageReply00](self.impl))
...
proc registerScriptMessageHandlerWithReply*(self: UserContentManager;
    name: cstring; worldName: cstring = nil): bool =
  toBool(webkit_user_content_manager_register_script_message_handler_with_reply(cast[ptr UserContentManager00](self.impl), name, worldName))
...
proc webkit_settings_apply_from_key_file(self: ptr Settings00; keyFile: ptr glib.KeyFile00;
    groupName: cstring; error: ptr ptr glib.Error = nil): gboolean {.
    importc, libprag.}

proc applyFromKeyFile*(self: Settings; keyFile: glib.KeyFile;
    groupName: cstring): bool =
  var gerror: ptr glib.Error
  let resul0 = webkit_settings_apply_from_key_file(cast[ptr Settings00](self.impl), cast[ptr glib.KeyFile00](keyFile.impl), groupName, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
    g_error_free(gerror[])
    raise newException(GException, msg)
...
proc webkit_settings_get_disable_web_security(self: ptr Settings00): gboolean {.
    importc, libprag.}

proc getDisableWebSecurity*(self: Settings): bool =
  toBool(webkit_settings_get_disable_web_security(cast[ptr Settings00](self.impl)))

proc disableWebSecurity*(self: Settings): bool =
  toBool(webkit_settings_get_disable_web_security(cast[ptr Settings00](self.impl)))
...
proc webkit_settings_get_enable_2d_canvas_acceleration(self: ptr Settings00): gboolean {.
    importc, libprag.}

proc getEnable_2dCanvasAcceleration*(self: Settings): bool =
...
proc webkit_settings_get_enable_webrtc(self: ptr Settings00): gboolean {.
    importc, libprag.}

proc getEnableWebrtc*(self: Settings): bool =
  toBool(webkit_settings_get_enable_webrtc(cast[ptr Settings00](self.impl)))

proc enableWebrtc*(self: Settings): bool =
  toBool(webkit_settings_get_enable_webrtc(cast[ptr Settings00](self.impl)))
...
proc webkit_settings_get_webrtc_udp_ports_range(self: ptr Settings00): cstring {.
    importc, libprag.}

proc getWebrtcUdpPortsRange*(self: Settings): string =
  result = $webkit_settings_get_webrtc_udp_ports_range(cast[ptr Settings00](self.impl))

proc webrtcUdpPortsRange*(self: Settings): string =
  result = $webkit_settings_get_webrtc_udp_ports_range(cast[ptr Settings00](self.impl))
...
proc webkit_settings_set_disable_web_security(self: ptr Settings00; disabled: gboolean) {.
    importc, libprag.}

proc setDisableWebSecurity*(self: Settings; disabled: bool = true) =
  webkit_settings_set_disable_web_security(cast[ptr Settings00](self.impl), gboolean(disabled))

proc `disableWebSecurity=`*(self: Settings; disabled: bool) =
  webkit_settings_set_disable_web_security(cast[ptr Settings00](self.impl), gboolean(disabled))
...
proc webkit_settings_set_enable_2d_canvas_acceleration(self: ptr Settings00;
    enabled: gboolean) {.
    importc, libprag.}

proc setEnable_2dCanvasAcceleration*(self: Settings; enabled: bool = true) =
...
proc webkit_settings_set_enable_webrtc(self: ptr Settings00; enabled: gboolean) {.
    importc, libprag.}

proc setEnableWebrtc*(self: Settings; enabled: bool = true) =
  webkit_settings_set_enable_webrtc(cast[ptr Settings00](self.impl), gboolean(enabled))

proc `enableWebrtc=`*(self: Settings; enabled: bool) =
  webkit_settings_set_enable_webrtc(cast[ptr Settings00](self.impl), gboolean(enabled))
...
proc webkit_settings_set_webrtc_udp_ports_range(self: ptr Settings00; udpPortRange: cstring) {.
    importc, libprag.}

proc setWebrtcUdpPortsRange*(self: Settings; udpPortRange: cstring) =
  webkit_settings_set_webrtc_udp_ports_range(cast[ptr Settings00](self.impl), udpPortRange)

proc `webrtcUdpPortsRange=`*(self: Settings; udpPortRange: cstring) =
  webkit_settings_set_webrtc_udp_ports_range(cast[ptr Settings00](self.impl), udpPortRange)
...
type
  FeatureList00* {.pure.} = object
  FeatureList* = ref object
    impl*: ptr FeatureList00
    ignoreFinalizer*: bool

proc webkit_feature_list_get_type*(): GType {.importc, libprag.}

proc gBoxedFreeWebKitFeatureList*(self: FeatureList) =
  if not self.ignoreFinalizer:
    boxedFree(webkit_feature_list_get_type(), cast[ptr FeatureList00](self.impl))

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(FeatureList()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    if not self.ignoreFinalizer and self.impl != nil:
      boxedFree(webkit_feature_list_get_type(), cast[ptr FeatureList00](self.impl))
...
proc newWithFinalizer*(x: var FeatureList) =
  when defined(gcDestructors):
    new(x)
  else:
    new(x, gBoxedFreeWebKitFeatureList)

proc webkit_feature_list_unref(self: ptr FeatureList00) {.
    importc, libprag.}

proc unref*(self: FeatureList) =
  webkit_feature_list_unref(cast[ptr FeatureList00](self.impl))

proc finalizerunref*(self: FeatureList) =
  if not self.ignoreFinalizer:
    webkit_feature_list_unref(cast[ptr FeatureList00](self.impl))

proc webkit_feature_list_get_length(self: ptr FeatureList00): uint64 {.
    importc, libprag.}

proc getLength*(self: FeatureList): uint64 =
  webkit_feature_list_get_length(cast[ptr FeatureList00](self.impl))

proc length*(self: FeatureList): uint64 =
  webkit_feature_list_get_length(cast[ptr FeatureList00](self.impl))

proc webkit_feature_list_ref(self: ptr FeatureList00): ptr FeatureList00 {.
    importc, libprag.}

proc `ref`*(self: FeatureList): FeatureList =
  fnew(result, gBoxedFreeWebKitFeatureList)
  result.impl = webkit_feature_list_ref(cast[ptr FeatureList00](self.impl))

proc webkit_settings_get_all_features(): ptr FeatureList00 {.
    importc, libprag.}

proc getAllFeatures*(): FeatureList =
  fnew(result, gBoxedFreeWebKitFeatureList)
  result.impl = webkit_settings_get_all_features()

proc webkit_settings_get_development_features(): ptr FeatureList00 {.
    importc, libprag.}

proc getDevelopmentFeatures*(): FeatureList =
  fnew(result, gBoxedFreeWebKitFeatureList)
  result.impl = webkit_settings_get_development_features()

proc webkit_settings_get_experimental_features(): ptr FeatureList00 {.
    importc, libprag.}

proc getExperimentalFeatures*(): FeatureList =
  fnew(result, gBoxedFreeWebKitFeatureList)
  result.impl = webkit_settings_get_experimental_features()

type
  Feature00* {.pure.} = object
  Feature* = ref object
    impl*: ptr Feature00
    ignoreFinalizer*: bool

proc webkit_feature_get_type*(): GType {.importc, libprag.}

proc gBoxedFreeWebKitFeature*(self: Feature) =
  if not self.ignoreFinalizer:
    boxedFree(webkit_feature_get_type(), cast[ptr Feature00](self.impl))

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(Feature()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    if not self.ignoreFinalizer and self.impl != nil:
      boxedFree(webkit_feature_get_type(), cast[ptr Feature00](self.impl))
...
proc newWithFinalizer*(x: var Feature) =
  when defined(gcDestructors):
    new(x)
  else:
    new(x, gBoxedFreeWebKitFeature)

proc webkit_feature_unref(self: ptr Feature00) {.
    importc, libprag.}

proc unref*(self: Feature) =
  webkit_feature_unref(cast[ptr Feature00](self.impl))

proc finalizerunref*(self: Feature) =
  if not self.ignoreFinalizer:
    webkit_feature_unref(cast[ptr Feature00](self.impl))

proc webkit_feature_get_default_value(self: ptr Feature00): gboolean {.
    importc, libprag.}

proc getDefaultValue*(self: Feature): bool =
  toBool(webkit_feature_get_default_value(cast[ptr Feature00](self.impl)))

proc defaultValue*(self: Feature): bool =
  toBool(webkit_feature_get_default_value(cast[ptr Feature00](self.impl)))

proc webkit_feature_get_details(self: ptr Feature00): cstring {.
    importc, libprag.}

proc getDetails*(self: Feature): string =
  let resul0 = webkit_feature_get_details(cast[ptr Feature00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc details*(self: Feature): string =
  let resul0 = webkit_feature_get_details(cast[ptr Feature00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc webkit_feature_get_identifier(self: ptr Feature00): cstring {.
    importc, libprag.}

proc getIdentifier*(self: Feature): string =
  result = $webkit_feature_get_identifier(cast[ptr Feature00](self.impl))

proc identifier*(self: Feature): string =
  result = $webkit_feature_get_identifier(cast[ptr Feature00](self.impl))

proc webkit_feature_get_name(self: ptr Feature00): cstring {.
    importc, libprag.}

proc getName*(self: Feature): string =
  let resul0 = webkit_feature_get_name(cast[ptr Feature00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc name*(self: Feature): string =
  let resul0 = webkit_feature_get_name(cast[ptr Feature00](self.impl))
  if resul0.isNil:
    return
  result = $resul0

proc webkit_feature_ref(self: ptr Feature00): ptr Feature00 {.
    importc, libprag.}

proc `ref`*(self: Feature): Feature =
  fnew(result, gBoxedFreeWebKitFeature)
  result.impl = webkit_feature_ref(cast[ptr Feature00](self.impl))

proc webkit_feature_get_category(self: ptr Feature00): cstring {.
    importc, libprag.}

proc getCategory*(self: Feature): string =
  result = $webkit_feature_get_category(cast[ptr Feature00](self.impl))

proc category*(self: Feature): string =
  result = $webkit_feature_get_category(cast[ptr Feature00](self.impl))

proc webkit_settings_get_feature_enabled(self: ptr Settings00; feature: ptr Feature00): gboolean {.
    importc, libprag.}

proc getFeatureEnabled*(self: Settings; feature: Feature): bool =
  toBool(webkit_settings_get_feature_enabled(cast[ptr Settings00](self.impl), cast[ptr Feature00](feature.impl)))

proc webkit_settings_set_feature_enabled(self: ptr Settings00; feature: ptr Feature00;
    enabled: gboolean) {.
    importc, libprag.}

proc setFeatureEnabled*(self: Settings; feature: Feature;
    enabled: bool) =
  webkit_settings_set_feature_enabled(cast[ptr Settings00](self.impl), cast[ptr Feature00](feature.impl), gboolean(enabled))

proc webkit_feature_list_get(self: ptr FeatureList00; index: uint64): ptr Feature00 {.
    importc, libprag.}

proc getFeatureList*(self: FeatureList; index: uint64): Feature =
  fnew(result, gBoxedFreeWebKitFeature)
  result.impl = webkit_feature_list_get(cast[ptr FeatureList00](self.impl), index)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(webkit_feature_get_type(), result.impl))

type
  FeatureStatus* {.size: sizeof(cint), pure.} = enum
    embedder = 0
    unstable = 1
    internal = 2
    developer = 3
...
proc webkit_feature_get_status(self: ptr Feature00): FeatureStatus {.
    importc, libprag.}

proc getStatus*(self: Feature): FeatureStatus =
  webkit_feature_get_status(cast[ptr Feature00](self.impl))

proc status*(self: Feature): FeatureStatus =
  webkit_feature_get_status(cast[ptr Feature00](self.impl))
...
type
  EditorTypingAttributesFlag* {.size: sizeof(cint), pure.} = enum
...
type
  FindOptionsFlag* {.size: sizeof(cint), pure.} = enum
    caseInsensitive = 0
    atWordStarts = 1
    treatMedialCapitalAsWordStart = 2
    backwards = 3
    wrapAround = 4
...
proc none*(t: typedesc[FindOptions]): FindOptions = FindOptions({})
...
proc webkit_response_policy_decision_is_main_frame_main_resource(self: ptr ResponsePolicyDecision00): gboolean {.
    importc, libprag.}

proc isMainFrameMainResource*(self: ResponsePolicyDecision): bool =
  toBool(webkit_response_policy_decision_is_main_frame_main_resource(cast[ptr ResponsePolicyDecision00](self.impl)))
...
proc webkit_uri_scheme_request_get_http_body(self: ptr URISchemeRequest00): ptr gio.InputStream00 {.
    importc, libprag.}

proc getHttpBody*(self: URISchemeRequest): gio.InputStream =
  let gobj = webkit_uri_scheme_request_get_http_body(cast[ptr URISchemeRequest00](self.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc httpBody*(self: URISchemeRequest): gio.InputStream =
  let gobj = webkit_uri_scheme_request_get_http_body(cast[ptr URISchemeRequest00](self.impl))
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
...
proc webkit_uri_scheme_request_get_http_headers(self: ptr URISchemeRequest00): ptr soup3.MessageHeaders00 {.
    importc, libprag.}

proc getHttpHeaders*(self: URISchemeRequest): soup3.MessageHeaders =
  fnew(result, gBoxedFreeSoupMessageHeaders)
  result.impl = webkit_uri_scheme_request_get_http_headers(cast[ptr URISchemeRequest00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(soup_message_headers_get_type(), result.impl))

proc httpHeaders*(self: URISchemeRequest): soup3.MessageHeaders =
  fnew(result, gBoxedFreeSoupMessageHeaders)
  result.impl = webkit_uri_scheme_request_get_http_headers(cast[ptr URISchemeRequest00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(soup_message_headers_get_type(), result.impl))
...
proc webkit_uri_scheme_response_set_http_headers(self: ptr URISchemeResponse00;
    headers: ptr soup3.MessageHeaders00) {.
    importc, libprag.}

proc setHttpHeaders*(self: URISchemeResponse;
    headers: soup3.MessageHeaders) =
  webkit_uri_scheme_response_set_http_headers(cast[ptr URISchemeResponse00](self.impl), cast[ptr soup3.MessageHeaders00](g_boxed_copy(soup_message_headers_get_type(), headers.impl)))
...
type
  WebExtensionMatchPattern00* {.pure.} = object
  WebExtensionMatchPattern* = ref object
    impl*: ptr WebExtensionMatchPattern00
    ignoreFinalizer*: bool

proc webkit_web_extension_match_pattern_get_type*(): GType {.importc, libprag.}

proc gBoxedFreeWebKitWebExtensionMatchPattern*(self: WebExtensionMatchPattern) =
  if not self.ignoreFinalizer:
    boxedFree(webkit_web_extension_match_pattern_get_type(), cast[ptr WebExtensionMatchPattern00](self.impl))

when defined(gcDestructors):
  proc `=destroy`*(self: var typeof(WebExtensionMatchPattern()[])) =
    when defined(gintroDebug):
      echo "destroy ", $typeof(self), ' ', cast[int](unsafeaddr self)
    if not self.ignoreFinalizer and self.impl != nil:
      boxedFree(webkit_web_extension_match_pattern_get_type(), cast[ptr WebExtensionMatchPattern00](self.impl))
...
proc newWithFinalizer*(x: var WebExtensionMatchPattern) =
  when defined(gcDestructors):
    new(x)
  else:
    new(x, gBoxedFreeWebKitWebExtensionMatchPattern)

proc webkit_web_extension_match_pattern_unref(self: ptr WebExtensionMatchPattern00) {.
    importc, libprag.}

proc unref*(self: WebExtensionMatchPattern) =
  webkit_web_extension_match_pattern_unref(cast[ptr WebExtensionMatchPattern00](self.impl))

proc finalizerunref*(self: WebExtensionMatchPattern) =
  if not self.ignoreFinalizer:
    webkit_web_extension_match_pattern_unref(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_new_all_urls(): ptr WebExtensionMatchPattern00 {.
    importc, libprag.}

proc newWebExtensionMatchPatternAllUrls*(): WebExtensionMatchPattern =
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_urls()

proc newWebExtensionMatchPatternAllUrls*(tdesc: typedesc): tdesc =
  assert(result is WebExtensionMatchPattern)
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_urls()

proc initWebExtensionMatchPatternAllUrls*[T](result: var T) {.deprecated.} =
  assert(result is WebExtensionMatchPattern)
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_urls()

proc webkit_web_extension_match_pattern_new_with_scheme(scheme: cstring;
    host: cstring; path: cstring; error: ptr ptr glib.Error = nil): ptr WebExtensionMatchPattern00 {.
    importc, libprag.}

proc newWebExtensionMatchPatternWithScheme*(scheme: cstring;
    host: cstring; path: cstring): WebExtensionMatchPattern =
  var gerror: ptr glib.Error
  let impl0 = webkit_web_extension_match_pattern_new_with_scheme(scheme, host, path, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
    g_error_free(gerror[])
    raise newException(GException, msg)
...
proc newWebExtensionMatchPatternWithScheme*(tdesc: typedesc; scheme: cstring;
    host: cstring; path: cstring): tdesc =
  var gerror: ptr glib.Error
  assert(result is WebExtensionMatchPattern)
  let impl0 = webkit_web_extension_match_pattern_new_with_scheme(scheme, host, path, addr gerror)
  if gerror != nil:
...
proc initWebExtensionMatchPatternWithScheme*[T](result: var T; scheme: cstring;
    host: cstring; path: cstring) {.deprecated.} =
  var gerror: ptr glib.Error
  assert(result is WebExtensionMatchPattern)
  let impl0 = webkit_web_extension_match_pattern_new_with_scheme(scheme, host, path, addr gerror)
  if gerror != nil:
...
proc webkit_web_extension_match_pattern_new_with_string(string: cstring;
    error: ptr ptr glib.Error = nil): ptr WebExtensionMatchPattern00 {.
    importc, libprag.}

proc newWebExtensionMatchPatternWithString*(string: cstring): WebExtensionMatchPattern =
  var gerror: ptr glib.Error
  let impl0 = webkit_web_extension_match_pattern_new_with_string(string, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
    g_error_free(gerror[])
    raise newException(GException, msg)
...
proc newWebExtensionMatchPatternWithString*(tdesc: typedesc; string: cstring): tdesc =
  var gerror: ptr glib.Error
  assert(result is WebExtensionMatchPattern)
  let impl0 = webkit_web_extension_match_pattern_new_with_string(string, addr gerror)
  if gerror != nil:
...
proc initWebExtensionMatchPatternWithString*[T](result: var T; string: cstring) {.deprecated.} =
  var gerror: ptr glib.Error
  assert(result is WebExtensionMatchPattern)
  let impl0 = webkit_web_extension_match_pattern_new_with_string(string, addr gerror)
  if gerror != nil:
...
proc webkit_web_extension_match_pattern_get_host(self: ptr WebExtensionMatchPattern00): cstring {.
    importc, libprag.}

proc getHost*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_host(cast[ptr WebExtensionMatchPattern00](self.impl))

proc host*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_host(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_get_matches_all_hosts(self: ptr WebExtensionMatchPattern00): gboolean {.
    importc, libprag.}

proc getMatchesAllHosts*(self: WebExtensionMatchPattern): bool =
  toBool(webkit_web_extension_match_pattern_get_matches_all_hosts(cast[ptr WebExtensionMatchPattern00](self.impl)))

proc matchesAllHosts*(self: WebExtensionMatchPattern): bool =
  toBool(webkit_web_extension_match_pattern_get_matches_all_hosts(cast[ptr WebExtensionMatchPattern00](self.impl)))

proc webkit_web_extension_match_pattern_get_matches_all_urls(self: ptr WebExtensionMatchPattern00): gboolean {.
    importc, libprag.}

proc getMatchesAllUrls*(self: WebExtensionMatchPattern): bool =
  toBool(webkit_web_extension_match_pattern_get_matches_all_urls(cast[ptr WebExtensionMatchPattern00](self.impl)))

proc matchesAllUrls*(self: WebExtensionMatchPattern): bool =
  toBool(webkit_web_extension_match_pattern_get_matches_all_urls(cast[ptr WebExtensionMatchPattern00](self.impl)))

proc webkit_web_extension_match_pattern_get_path(self: ptr WebExtensionMatchPattern00): cstring {.
    importc, libprag.}

proc getPath*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_path(cast[ptr WebExtensionMatchPattern00](self.impl))

proc path*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_path(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_get_scheme(self: ptr WebExtensionMatchPattern00): cstring {.
    importc, libprag.}

proc getScheme*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_scheme(cast[ptr WebExtensionMatchPattern00](self.impl))

proc scheme*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_scheme(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_get_string(self: ptr WebExtensionMatchPattern00): cstring {.
    importc, libprag.}

proc getString*(self: WebExtensionMatchPattern): string =
  result = $webkit_web_extension_match_pattern_get_string(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_ref(self: ptr WebExtensionMatchPattern00): ptr WebExtensionMatchPattern00 {.
    importc, libprag.}

proc `ref`*(self: WebExtensionMatchPattern): WebExtensionMatchPattern =
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_ref(cast[ptr WebExtensionMatchPattern00](self.impl))

proc webkit_web_extension_match_pattern_new_all_hosts_and_schemes(): ptr WebExtensionMatchPattern00 {.
    importc, libprag.}

proc newWebExtensionMatchPatternAllHostsAndSchemes*(): WebExtensionMatchPattern =
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_hosts_and_schemes()

proc newWebExtensionMatchPatternAllHostsAndSchemes*(tdesc: typedesc): tdesc =
  assert(result is WebExtensionMatchPattern)
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_hosts_and_schemes()

proc initWebExtensionMatchPatternAllHostsAndSchemes*[T](result: var T) {.deprecated.} =
  assert(result is WebExtensionMatchPattern)
  fnew(result, gBoxedFreeWebKitWebExtensionMatchPattern)
  result.impl = webkit_web_extension_match_pattern_new_all_hosts_and_schemes()

proc registerCustom_URL_scheme*(urlScheme: cstring) {.
    importc: "webkit_web_extension_match_pattern_register_custom_URL_scheme", libprag.}

type
  WebExtensionMatchPatternOptionsFlag* {.size: sizeof(cint), pure.} = enum
    none = 0
    ignoreSchemes = 1
    ignorePaths = 2
...
proc matchesPattern*(self: WebExtensionMatchPattern;
    pattern: WebExtensionMatchPattern; options: WebExtensionMatchPatternOptions): bool =
  toBool(webkit_web_extension_match_pattern_matches_pattern(cast[ptr WebExtensionMatchPattern00](self.impl), cast[ptr WebExtensionMatchPattern00](pattern.impl), options))

proc webkit_web_extension_match_pattern_matches_url(self: ptr WebExtensionMatchPattern00;
    url: cstring; options: WebExtensionMatchPatternOptions): gboolean {.
    importc, libprag.}

proc matchesUrl*(self: WebExtensionMatchPattern;
    url: cstring; options: WebExtensionMatchPatternOptions): bool =
  toBool(webkit_web_extension_match_pattern_matches_url(cast[ptr WebExtensionMatchPattern00](self.impl), url, options))

type
  WebExtensionMatchPatternError* {.size: sizeof(cint), pure.} = enum
    invalidScheme = 808
    invalidHost = 809
    invalidPath = 810
    unknown = 899
