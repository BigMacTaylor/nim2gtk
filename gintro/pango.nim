...
import gobject, gio, cairo, glib, harfbuzz, freetype2, gmodule
...
const ATTR_INDEX_TO_TEXT_END* = 4294967295'u32
...
proc pango_attribute_as_color(self: ptr Attribute00): ptr AttrColor00 {.
    importc, libprag.}

proc asColor*(self: Attribute): AttrColor =
  let impl0 = pango_attribute_as_color(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_float(self: ptr Attribute00): ptr AttrFloat00 {.
    importc, libprag.}

proc asFloat*(self: Attribute): AttrFloat =
  let impl0 = pango_attribute_as_float(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_font_desc(self: ptr Attribute00): ptr AttrFontDesc00 {.
    importc, libprag.}

proc asFontDesc*(self: Attribute): AttrFontDesc =
  let impl0 = pango_attribute_as_font_desc(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc setVariations*(self: FontDescription; variations: cstring = nil) =
  pango_font_description_set_variations(cast[ptr FontDescription00](self.impl), variations)

proc `variations=`*(self: FontDescription; variations: cstring = nil) =
  pango_font_description_set_variations(cast[ptr FontDescription00](self.impl), variations)
...
proc pango_matrix_get_slant_ratio(self: ptr Matrix00): cdouble {.
    importc, libprag.}

proc getSlantRatio*(self: Matrix): cdouble =
  pango_matrix_get_slant_ratio(cast[ptr Matrix00](self.impl))

proc slantRatio*(self: Matrix): cdouble =
  pango_matrix_get_slant_ratio(cast[ptr Matrix00](self.impl))
...
proc transformPixelRectangle*(self: Matrix; rect: var Rectangle) =
...
proc transformRectangle*(self: Matrix; rect: var Rectangle) =
...
proc getPreferred*(): ptr ptr Language00 {.
    importc: "pango_language_get_preferred", libprag.}
...
type
  FontMaskFlag* {.size: sizeof(cint), pure.} = enum
    family = 0
    style = 1
    variant = 2
    weight = 3
...
proc pango_attribute_as_font_features(self: ptr Attribute00): ptr AttrFontFeatures00 {.
    importc, libprag.}

proc asFontFeatures*(self: Attribute): AttrFontFeatures =
  let impl0 = pango_attribute_as_font_features(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_int(self: ptr Attribute00): ptr AttrInt00 {.
    importc, libprag.}

proc asInt*(self: Attribute): AttrInt =
  let impl0 = pango_attribute_as_int(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_language(self: ptr Attribute00): ptr AttrLanguage00 {.
    importc, libprag.}

proc asLanguage*(self: Attribute): AttrLanguage =
  let impl0 = pango_attribute_as_language(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_shape(self: ptr Attribute00): ptr AttrShape00 {.
    importc, libprag.}

proc asShape*(self: Attribute): AttrShape =
  let impl0 = pango_attribute_as_shape(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_size(self: ptr Attribute00): ptr AttrSize00 {.
    importc, libprag.}

proc asSize*(self: Attribute): AttrSize =
  let impl0 = pango_attribute_as_size(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attribute_as_string(self: ptr Attribute00): ptr AttrString00 {.
    importc, libprag.}

proc asString*(self: Attribute): AttrString =
  let impl0 = pango_attribute_as_string(cast[ptr Attribute00](self.impl))
  if impl0.isNil:
    return nil
  new(result)
  result.impl = impl0
...
proc pango_attr_iterator_get_font(self: AttrIterator; desc: ptr FontDescription00;
    language: var ptr Language00; extraAttrs: var ptr glib.SList) {.
    importc, libprag.}

proc getFont*(self: AttrIterator; desc: FontDescription;
    language: var Language = cast[var Language](nil); extraAttrs: var seq[Attribute] = cast[var seq[Attribute]](nil)) =
  var tempResGL = seq2GSList(extraAttrs)
  if addr(language) != nil:
    fnew(language, gBoxedFreePangoLanguage)
  pango_attr_iterator_get_font(self, cast[ptr FontDescription00](desc.impl), cast[var ptr Language00](if addr(language) == nil: nil else: addr language.impl), tempResGL)
...
proc pango_attr_list_to_string(self: ptr AttrList00): cstring {.
    importc, libprag.}

proc toString*(self: AttrList): string =
  let resul0 = pango_attr_list_to_string(cast[ptr AttrList00](self.impl))
  result = $resul0
  cogfree(resul0)
...
proc pango_attr_list_from_string(text: cstring): ptr AttrList00 {.
    importc, libprag.}

proc fromStringAttrList*(text: cstring): AttrList =
  let impl0 = pango_attr_list_from_string(text)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoAttrList)
  result.impl = impl0
...
type
  BaselineShift* {.size: sizeof(cint), pure.} = enum
    none = 0
    superscript = 1
    subscript = 2
...
proc getFontDescription*(self: Context): FontDescription =
  let impl0 = pango_context_get_font_description(cast[ptr Context00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoFontDescription)
...
proc setFontDescription*(self: Context; desc: FontDescription = nil) =
  pango_context_set_font_description(cast[ptr Context00](self.impl), if desc.isNil: nil else: cast[ptr FontDescription00](desc.impl))

proc `fontDescription=`*(self: Context; desc: FontDescription = nil) =
  pango_context_set_font_description(cast[ptr Context00](self.impl), if desc.isNil: nil else: cast[ptr FontDescription00](desc.impl))
...
proc setLanguage*(self: Context; language: Language = nil) =
  pango_context_set_language(cast[ptr Context00](self.impl), if language.isNil: nil else: cast[ptr Language00](language.impl))

proc `language=`*(self: Context; language: Language = nil) =
  pango_context_set_language(cast[ptr Context00](self.impl), if language.isNil: nil else: cast[ptr Language00](language.impl))
...
proc pango_font_deserialize(context: ptr Context00; bytes: ptr glib.Bytes00;
    error: ptr ptr glib.Error = nil): ptr Font00 {.
    importc, libprag.}

proc deserialize*(context: Context; bytes: glib.Bytes): Font =
  var gerror: ptr glib.Error
  let gobj = pango_font_deserialize(cast[ptr Context00](context.impl), cast[ptr glib.Bytes00](bytes.impl), addr gerror)
  if gerror != nil:
...
proc pango_font_get_features(self: ptr Font00; features: var ptr harfbuzz.featureT00;
    len: uint32; numFeatures: var uint32) {.
    importc, libprag.}

proc getFeatures*(self: Font; features: var ptr harfbuzz.featureT00;
    len: int; numFeatures: var int) =
  var numFeatures_00 = uint32(numFeatures)
  pango_font_get_features(cast[ptr Font00](self.impl), features, uint32(len), numFeatures_00)
...
proc pango_font_get_languages(self: ptr Font00): ptr Language00 {.
    importc, libprag.}

proc getLanguages*(self: Font): ptr Language00 =
  pango_font_get_languages(cast[ptr Font00](self.impl))

proc languages*(self: Font): ptr Language00 =
  pango_font_get_languages(cast[ptr Font00](self.impl))
...
proc pango_font_serialize(self: ptr Font00): ptr glib.Bytes00 {.
    importc, libprag.}

proc serialize*(self: Font): glib.Bytes =
  fnew(result, gBoxedFreeGBytes)
  result.impl = pango_font_serialize(cast[ptr Font00](self.impl))
...
proc pango_font_map_reload_font(self: ptr FontMap00; font: ptr Font00; scale: cdouble;
    context: ptr Context00; variations: cstring): ptr Font00 {.
    importc, libprag.}

proc reloadFont*(self: FontMap; font: Font; scale: cdouble;
    context: Context = nil; variations: cstring = nil): Font =
  let gobj = pango_font_map_reload_font(cast[ptr FontMap00](self.impl), cast[ptr Font00](font.impl), scale, if context.isNil: nil else: cast[ptr Context00](context.impl), variations)
  let qdata = g_object_get_qdata(gobj, Quark)
  if qdata != nil:
    result = cast[type(result)](qdata)
    assert(result.impl == gobj)
...
proc setFontMap*(self: Context; fontMap: FontMap = nil) =
  pango_context_set_font_map(cast[ptr Context00](self.impl), if fontMap.isNil: nil else: cast[ptr FontMap00](fontMap.impl))

proc `fontMap=`*(self: Context; fontMap: FontMap = nil) =
  pango_context_set_font_map(cast[ptr Context00](self.impl), if fontMap.isNil: nil else: cast[ptr FontMap00](fontMap.impl))
...
type
  FontScale* {.size: sizeof(cint), pure.} = enum
    none = 0
    superscript = 1
    subscript = 2
    smallCaps = 3
...
proc append*(self: FontsetSimple; font: Font) =
  pango_fontset_simple_append(cast[ptr FontsetSimple00](self.impl), cast[ptr Font00](g_object_ref(font.impl)))
...
proc split*(self: GlyphItem; text: cstring; splitIndex: int): GlyphItem =
  let impl0 = pango_glyph_item_split(cast[ptr GlyphItem00](self.impl), text, int32(splitIndex))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoGlyphItem)
  result.impl = impl0
...
proc pango_glyph_string_index_to_x_full(self: ptr GlyphString00; text: cstring;
    length: int32; analysis: ptr Analysis00; attrs: ptr LogAttr00; index: int32;
    trailing: gboolean; xPos: var int32) {.
    importc, libprag.}

proc indexToXFull*(self: GlyphString; text: cstring;
    length: int; analysis: Analysis; attrs: LogAttr = nil; index: int; trailing: bool;
    xPos: var int) =
  var xPos_00: int32
  pango_glyph_string_index_to_x_full(cast[ptr GlyphString00](self.impl), text, int32(length), cast[ptr Analysis00](analysis.impl), if attrs.isNil: nil else: cast[ptr LogAttr00](attrs.impl), int32(index), gboolean(trailing), xPos_00)
  if xPos.addr != nil:
    xPos = int(xPos_00)
...
proc pango_layout_get_caret_pos(self: ptr Layout00; index: int32; strongPos: var Rectangle;
    weakPos: var Rectangle) {.
    importc, libprag.}

proc getCaretPos*(self: Layout; index: int; strongPos: var Rectangle = cast[var Rectangle](nil);
    weakPos: var Rectangle = cast[var Rectangle](nil)) =
  pango_layout_get_caret_pos(cast[ptr Layout00](self.impl), int32(index), strongPos, weakPos)
...
proc pango_layout_get_justify_last_line(self: ptr Layout00): gboolean {.
    importc, libprag.}

proc getJustifyLastLine*(self: Layout): bool =
  toBool(pango_layout_get_justify_last_line(cast[ptr Layout00](self.impl)))

proc justifyLastLine*(self: Layout): bool =
  toBool(pango_layout_get_justify_last_line(cast[ptr Layout00](self.impl)))
...
proc pango_layout_set_justify_last_line(self: ptr Layout00; justify: gboolean) {.
    importc, libprag.}

proc setJustifyLastLine*(self: Layout; justify: bool = true) =
  pango_layout_set_justify_last_line(cast[ptr Layout00](self.impl), gboolean(justify))

proc `justifyLastLine=`*(self: Layout; justify: bool) =
  pango_layout_set_justify_last_line(cast[ptr Layout00](self.impl), gboolean(justify))
...
proc default*(t: typedesc[LayoutDeserializeFlags]): LayoutDeserializeFlags = LayoutDeserializeFlags({})

proc pango_layout_deserialize(context: ptr Context00; bytes: ptr glib.Bytes00;
    flags: LayoutDeserializeFlags; error: ptr ptr glib.Error = nil): ptr Layout00 {.
    importc, libprag.}

proc deserialize*(context: Context; bytes: glib.Bytes; flags: LayoutDeserializeFlags): Layout =
  var gerror: ptr glib.Error
  let gobj = pango_layout_deserialize(cast[ptr Context00](context.impl), cast[ptr glib.Bytes00](bytes.impl), flags, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
    g_error_free(gerror[])
    raise newException(GException, msg)
...
proc pango_layout_iter_get_run_baseline(self: ptr LayoutIter00): int32 {.
    importc, libprag.}

proc getRunBaseline*(self: LayoutIter): int =
  int(pango_layout_iter_get_run_baseline(cast[ptr LayoutIter00](self.impl)))

proc runBaseline*(self: LayoutIter): int =
  int(pango_layout_iter_get_run_baseline(cast[ptr LayoutIter00](self.impl)))
...
proc pango_layout_line_get_length(self: ptr LayoutLine00): int32 {.
    importc, libprag.}

proc getLength*(self: LayoutLine): int =
  int(pango_layout_line_get_length(cast[ptr LayoutLine00](self.impl)))

proc length*(self: LayoutLine): int =
  int(pango_layout_line_get_length(cast[ptr LayoutLine00](self.impl)))
...
proc pango_layout_line_get_resolved_direction(self: ptr LayoutLine00): Direction {.
    importc, libprag.}

proc getResolvedDirection*(self: LayoutLine): Direction =
  pango_layout_line_get_resolved_direction(cast[ptr LayoutLine00](self.impl))

proc resolvedDirection*(self: LayoutLine): Direction =
  pango_layout_line_get_resolved_direction(cast[ptr LayoutLine00](self.impl))

proc pango_layout_line_get_start_index(self: ptr LayoutLine00): int32 {.
    importc, libprag.}

proc getStartIndex*(self: LayoutLine): int =
  int(pango_layout_line_get_start_index(cast[ptr LayoutLine00](self.impl)))

proc startIndex*(self: LayoutLine): int =
  int(pango_layout_line_get_start_index(cast[ptr LayoutLine00](self.impl)))
...
proc pango_layout_line_is_paragraph_start(self: ptr LayoutLine00): gboolean {.
    importc, libprag.}

proc isParagraphStart*(self: LayoutLine): bool =
  toBool(pango_layout_line_is_paragraph_start(cast[ptr LayoutLine00](self.impl)))

proc pango_layout_line_ref(self: ptr LayoutLine00): ptr LayoutLine00 {.
    importc, libprag.}

proc `ref`*(self: LayoutLine): LayoutLine =
  let impl0 = pango_layout_line_ref(cast[ptr LayoutLine00](self.impl))
  if impl0.isNil:
    return nil
...
proc getLine*(self: LayoutIter): LayoutLine =
  let impl0 = pango_layout_iter_get_line(cast[ptr LayoutIter00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoLayoutLine)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(pango_layout_line_get_type(), impl0))
...
proc getLineReadonly*(self: LayoutIter): LayoutLine =
  let impl0 = pango_layout_iter_get_line_readonly(cast[ptr LayoutIter00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoLayoutLine)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(pango_layout_line_get_type(), impl0))
...
proc pango_tab_array_get_decimal_point(self: ptr TabArray00; tabIndex: int32): gunichar {.
    importc, libprag.}

proc getDecimalPoint*(self: TabArray; tabIndex: int): gunichar =
  pango_tab_array_get_decimal_point(cast[ptr TabArray00](self.impl), int32(tabIndex))
...
proc pango_tab_array_set_decimal_point(self: ptr TabArray00; tabIndex: int32;
    decimalPoint: gunichar) {.
    importc, libprag.}

proc setDecimalPoint*(self: TabArray; tabIndex: int; decimalPoint: gunichar) =
  pango_tab_array_set_decimal_point(cast[ptr TabArray00](self.impl), int32(tabIndex), decimalPoint)

proc pango_tab_array_set_positions_in_pixels(self: ptr TabArray00; positionsInPixels: gboolean) {.
    importc, libprag.}

proc setPositionsInPixels*(self: TabArray; positionsInPixels: bool = true) =
  pango_tab_array_set_positions_in_pixels(cast[ptr TabArray00](self.impl), gboolean(positionsInPixels))

proc `positionsInPixels=`*(self: TabArray; positionsInPixels: bool) =
  pango_tab_array_set_positions_in_pixels(cast[ptr TabArray00](self.impl), gboolean(positionsInPixels))

proc pango_tab_array_sort(self: ptr TabArray00) {.
    importc, libprag.}

proc sort*(self: TabArray) =
  pango_tab_array_sort(cast[ptr TabArray00](self.impl))

proc pango_tab_array_to_string(self: ptr TabArray00): cstring {.
    importc, libprag.}

proc toString*(self: TabArray): string =
  let resul0 = pango_tab_array_to_string(cast[ptr TabArray00](self.impl))
  result = $resul0
  cogfree(resul0)

proc pango_tab_array_from_string(text: cstring): ptr TabArray00 {.
    importc, libprag.}

proc fromStringTabArray*(text: cstring): TabArray =
  let impl0 = pango_tab_array_from_string(text)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreePangoTabArray)
  result.impl = impl0
...
type
  LayoutSerializeFlag* {.size: sizeof(cint), pure.} = enum
    context = 0
    output = 1
...
proc default*(t: typedesc[LayoutSerializeFlags]): LayoutSerializeFlags = LayoutSerializeFlags({})

proc pango_layout_serialize(self: ptr Layout00; flags: LayoutSerializeFlags): ptr glib.Bytes00 {.
    importc, libprag.}

proc serialize*(self: Layout; flags: LayoutSerializeFlags): glib.Bytes =
  fnew(result, gBoxedFreeGBytes)
  result.impl = pango_layout_serialize(cast[ptr Layout00](self.impl), flags)

proc pango_layout_write_to_file(self: ptr Layout00; flags: LayoutSerializeFlags;
    filename: cstring; error: ptr ptr glib.Error = nil): gboolean {.
    importc, libprag.}

proc writeToFile*(self: Layout; flags: LayoutSerializeFlags;
    filename: cstring): bool =
  var gerror: ptr glib.Error
  let resul0 = pango_layout_write_to_file(cast[ptr Layout00](self.impl), flags, filename, addr gerror)
  if gerror != nil:
    let msg = $gerror.message
    g_error_free(gerror[])
    raise newException(GException, msg)
...
type
  LayoutDeserializeError* {.size: sizeof(cint), pure.} = enum
    invalid = 0
    invalidValue = 1
    missingValue = 2
...
type
  TextTransform* {.size: sizeof(cint), pure.} = enum
    none = 0
    lowercase = 1
    uppercase = 2
    capitalize = 3
...
const VERSION_MICRO* = 1'i32

const VERSION_MINOR* = 52'i32
...
proc pango_attr_baseline_shift_new(shift: int32): ptr Attribute00 {.
    importc, libprag.}

proc newAttrBaselineShift*(shift: int): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_baseline_shift_new(int32(shift))

proc pango_attr_break(text: cstring; length: int32; attrList: ptr AttrList00;
    offset: int32; attrs: ptr LogAttr00; attrsLen: int32) {.
    importc, libprag.}

proc attrBreak*(text: cstring; length: int; attrList: AttrList; offset: int;
    attrs: ptr LogAttr00; attrsLen: int) =
  pango_attr_break(text, int32(length), cast[ptr AttrList00](attrList.impl), int32(offset), attrs, int32(attrsLen))
...
proc pango_attr_font_scale_new(scale: FontScale): ptr Attribute00 {.
    importc, libprag.}

proc newAttrFontScale*(scale: FontScale): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_font_scale_new(scale)
...
proc pango_attr_line_height_new(factor: cdouble): ptr Attribute00 {.
    importc, libprag.}

proc newAttrLineHeight*(factor: cdouble): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_line_height_new(factor)

proc pango_attr_line_height_new_absolute(height: int32): ptr Attribute00 {.
    importc, libprag.}

proc attrLineHeightNewAbsolute*(height: int): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_line_height_new_absolute(int32(height))
...
proc pango_attr_sentence_new(): ptr Attribute00 {.
    importc, libprag.}

proc newAttrSentence*(): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_sentence_new()
...
proc pango_attr_text_transform_new(transform: TextTransform): ptr Attribute00 {.
    importc, libprag.}

proc newAttrTextTransform*(transform: TextTransform): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_text_transform_new(transform)
...
proc pango_attr_word_new(): ptr Attribute00 {.
    importc, libprag.}

proc newAttrWord*(): Attribute =
  fnew(result, gBoxedFreePangoAttribute)
  result.impl = pango_attr_word_new()
...
proc getLogAttrs*(text: cstring; length: int; level: int; language: Language;
    attrs: ptr LogAttr00; attrsLen: int) =
  pango_get_log_attrs(text, int32(length), int32(level), cast[ptr Language00](language.impl), attrs, int32(attrsLen))
...
proc pango_reorder_items(items: ptr glib.List): ptr glib.List {.
    importc, libprag.}

proc reorderItems*(items: seq[Item]): seq[Item] =
...
proc pango_shape_item(item: ptr Item00; paragraphText: cstring; paragraphLength: int32;
    logAttrs: ptr LogAttr00; glyphs: ptr GlyphString00; flags: ShapeFlags) {.
    importc, libprag.}

proc shapeItem*(item: Item; paragraphText: cstring = nil; paragraphLength: int;
    logAttrs: LogAttr = nil; glyphs: GlyphString; flags: ShapeFlags) =
  pango_shape_item(cast[ptr Item00](item.impl), paragraphText, int32(paragraphLength), if logAttrs.isNil: nil else: cast[ptr LogAttr00](logAttrs.impl), cast[ptr GlyphString00](glyphs.impl), flags)
...
proc tailorBreak*(text: cstring; length: int; analysis: Analysis; offset: int;
    attrs: ptr LogAttr00; attrsLen: int) =
  pango_tailor_break(text, int32(length), cast[ptr Analysis00](analysis.impl), int32(offset), attrs, int32(attrsLen))
...
proc listModel*(x: pango.FontFamily): gio.ListModel = cast[gio.ListModel](x)

proc listModel*(x: pango.FontMap): gio.ListModel = cast[gio.ListModel](x)
