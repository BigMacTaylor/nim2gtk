...
import freetype2, xlib, glib, gdk, harfbuzz, gmodule, cairo, gtk, gobject, pango, gio, atk, gdkpixbuf
...
proc vte_event_context_get_event(self: ptr EventContext00): ptr gdk.Event00 {.
    importc, libprag.}

proc getEvent*(self: EventContext): gdk.Event =
  fnew(result, gBoxedFreeGdkEvent)
  result.impl = vte_event_context_get_event(cast[ptr EventContext00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gdk_event_get_type(), result.impl))

proc event*(self: EventContext): gdk.Event =
  fnew(result, gBoxedFreeGdkEvent)
  result.impl = vte_event_context_get_event(cast[ptr EventContext00](self.impl))
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gdk_event_get_type(), result.impl))
...
proc vte_terminal_get_context_menu(self: ptr Terminal00): ptr gtk.Widget00 {.
    importc, libprag.}

proc getContextMenu*(self: Terminal): gtk.Widget =
...
proc contextMenu*(self: Terminal): gtk.Widget =
  let gobj = vte_terminal_get_context_menu(cast[ptr Terminal00](self.impl))
  if gobj.isNil:
    return nil
  let qdata = g_object_get_qdata(gobj, Quark)
...
proc vte_terminal_set_context_menu(self: ptr Terminal00; menu: ptr gtk.Widget00) {.
    importc, libprag.}

proc setContextMenu*(self: Terminal; menu: gtk.Widget = nil) =
  vte_terminal_set_context_menu(cast[ptr Terminal00](self.impl), if menu.isNil: nil else: cast[ptr gtk.Widget00](menu.impl))

proc `contextMenu=`*(self: Terminal; menu: gtk.Widget = nil) =
  vte_terminal_set_context_menu(cast[ptr Terminal00](self.impl), if menu.isNil: nil else: cast[ptr gtk.Widget00](menu.impl))
