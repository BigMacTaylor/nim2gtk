...
proc tagFromId3Tag*(id3Tag: cstring): string =
  let resul0 = gst_tag_from_id3_tag(id3Tag)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagFromId3UserTag*(`type`: cstring; id3UserTag: cstring): string =
  let resul0 = gst_tag_from_id3_user_tag(`type`, id3UserTag)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagFromVorbisTag*(vorbisTag: cstring): string =
  let resul0 = gst_tag_from_vorbis_tag(vorbisTag)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLanguageCodeIso_639_1*(langCode: cstring): string =
  let resul0 = gst_tag_get_language_code_iso_639_1(langCode)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLanguageCodeIso_639_2B*(langCode: cstring): string =
  let resul0 = gst_tag_get_language_code_iso_639_2B(langCode)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLanguageCodeIso_639_2T*(langCode: cstring): string =
  let resul0 = gst_tag_get_language_code_iso_639_2T(langCode)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLanguageName*(languageCode: cstring): string =
  let resul0 = gst_tag_get_language_name(languageCode)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLicenseDescription*(licenseRef: cstring): string =
  let resul0 = gst_tag_get_license_description(licenseRef)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLicenseJurisdiction*(licenseRef: cstring): string =
  let resul0 = gst_tag_get_license_jurisdiction(licenseRef)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLicenseNick*(licenseRef: cstring): string =
  let resul0 = gst_tag_get_license_nick(licenseRef)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLicenseTitle*(licenseRef: cstring): string =
  let resul0 = gst_tag_get_license_title(licenseRef)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagGetLicenseVersion*(licenseRef: cstring): string =
  let resul0 = gst_tag_get_license_version(licenseRef)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagId3GenreGet*(id: int): string =
  let resul0 = gst_tag_id3_genre_get(uint32(id))
  if resul0.isNil:
    return
  result = $resul0
...
proc tagImageDataToImageSample*(imageData: seq[uint8] | string; imageType: TagImageType): gst.Sample =
  ...
  let impl0 = gst_tag_image_data_to_image_sample(cast[ptr uint8](unsafeaddr(imageData[0])), uint32(imageDataLen), imageType)
  if impl0.isNil:
    return nil
...
proc tagListFromId3v2Tag*(buffer: gst.Buffer): gst.TagList =
  let impl0 = gst_tag_list_from_id3v2_tag(cast[ptr gst.Buffer00](buffer.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = impl0
...
proc tagListFromVorbiscomment*(data: seq[uint8] | string; size: uint64;
  ...
  let impl0 = gst_tag_list_from_vorbiscomment(cast[ptr uint8](unsafeaddr(data[0])), size, cast[ptr uint8](unsafeaddr(idData[0])), uint32(idDataLength), vendorString_00)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = impl0
...
proc tagListFromVorbiscommentBuffer*(buffer: gst.Buffer; idData: seq[uint8] | string;
  ...
  let idDataLength = int(idData.len)
  var vendorString_00: cstring
  let impl0 = gst_tag_list_from_vorbiscomment_buffer(cast[ptr gst.Buffer00](buffer.impl), cast[ptr uint8](unsafeaddr(idData[0])), uint32(idDataLength), vendorString_00)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = impl0
...
proc tagListFromXmpBuffer*(buffer: gst.Buffer): gst.TagList =
  let impl0 = gst_tag_list_from_xmp_buffer(cast[ptr gst.Buffer00](buffer.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = impl0
...
proc tagListNewFromId3v1*(data: ptr array[128, uint8]): gst.TagList =
  let impl0 = gst_tag_list_new_from_id3v1(data)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = impl0
...
proc tagListToXmpBuffer*(list: gst.TagList; readOnly: bool; schemas: varargs[string, `$`]): gst.Buffer =
  var fs469n23x: array[256, pointer]
  var fs469n23: cstringArray = cast[cstringArray](addr fs469n23x)
  let impl0 = gst_tag_list_to_xmp_buffer(cast[ptr gst.TagList00](list.impl), gboolean(readOnly), seq2CstringArray(schemas, fs469n23))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstBuffer)
  result.impl = impl0
...
proc tagToId3Tag*(gstTag: cstring): string =
  let resul0 = gst_tag_to_id3_tag(gstTag)
  if resul0.isNil:
    return
  result = $resul0
...
proc tagToVorbisTag*(gstTag: cstring): string =
  let resul0 = gst_tag_to_vorbis_tag(gstTag)
  if resul0.isNil:
    return
  result = $resul0
