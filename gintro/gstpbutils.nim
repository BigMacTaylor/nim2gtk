...
proc getMisc*(self: DiscovererInfo): gst.Structure =
  let impl0 = gst_discoverer_info_get_misc(cast[ptr DiscovererInfo00](self.impl))
  if impl0.isNil:
    return nil
...
proc getTags*(self: DiscovererInfo): gst.TagList =
  let impl0 = gst_discoverer_info_get_tags(cast[ptr DiscovererInfo00](self.impl))
  if impl0.isNil:
    return nil
...
proc getToc*(self: DiscovererInfo): gst.Toc =
  let impl0 = gst_discoverer_info_get_toc(cast[ptr DiscovererInfo00](self.impl))
  if impl0.isNil:
    return nil
...
proc scLoadSerializedInfo*(self: Discoverer;  p: proc (self: ptr Discoverer00; uri: cstring; xdata: pointer): ptr DiscovererInfo00 {.cdecl.}, xdata: pointer, cf: gobject.ConnectFlags): culong =
  g_signal_connect_data(self.impl, "load-serialized-info", cast[GCallback](p), xdata, nil, cf)
...
proc getCaps*(self: DiscovererStreamInfo): gst.Caps =
  let impl0 = gst_discoverer_stream_info_get_caps(cast[ptr DiscovererStreamInfo00](self.impl))
  if impl0.isNil:
    return nil
...
proc getMisc*(self: DiscovererStreamInfo): gst.Structure =
  let impl0 = gst_discoverer_stream_info_get_misc(cast[ptr DiscovererStreamInfo00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstStructure)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_structure_get_type(), impl0))
...
proc getStreamId*(self: DiscovererStreamInfo): string =
  let resul0 = gst_discoverer_stream_info_get_stream_id(cast[ptr DiscovererStreamInfo00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc gst_discoverer_stream_info_get_stream_number(self: ptr DiscovererStreamInfo00): int32 {.
    importc, libprag.}

proc getStreamNumber*(self: DiscovererStreamInfo): int =
  int(gst_discoverer_stream_info_get_stream_number(cast[ptr DiscovererStreamInfo00](self.impl)))

proc streamNumber*(self: DiscovererStreamInfo): int =
  int(gst_discoverer_stream_info_get_stream_number(cast[ptr DiscovererStreamInfo00](self.impl)))
...
proc getTags*(self: DiscovererStreamInfo): gst.TagList =
  let impl0 = gst_discoverer_stream_info_get_tags(cast[ptr DiscovererStreamInfo00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_tag_list_get_type(), impl0))
...
proc getToc*(self: DiscovererStreamInfo): gst.Toc =
  let impl0 = gst_discoverer_stream_info_get_toc(cast[ptr DiscovererStreamInfo00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstToc)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_toc_get_type(), impl0))
...
proc gst_discoverer_container_info_get_tags(self: ptr DiscovererContainerInfo00): ptr gst.TagList00 {.
    importc, libprag.}

proc getTags*(self: DiscovererContainerInfo): gst.TagList =
  let impl0 = gst_discoverer_container_info_get_tags(cast[ptr DiscovererContainerInfo00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
  result.impl = cast[typeof(result.impl)](g_boxed_copy(gst_tag_list_get_type(), impl0))

proc tags*(self: DiscovererContainerInfo): gst.TagList =
  let impl0 = gst_discoverer_container_info_get_tags(cast[ptr DiscovererContainerInfo00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstTagList)
...
proc getLanguage*(self: DiscovererAudioInfo): string =
  let resul0 = gst_discoverer_audio_info_get_language(cast[ptr DiscovererAudioInfo00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getAudioStreams*(self: DiscovererInfo): seq[DiscovererAudioInfo] =
  let resul0 = gst_discoverer_info_get_audio_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererAudioInfo, resul0, true)
  g_list_free(resul0)

proc audioStreams*(self: DiscovererInfo): seq[DiscovererAudioInfo] =
  let resul0 = gst_discoverer_info_get_audio_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererAudioInfo, resul0, true)
  g_list_free(resul0)
...
proc getContainerStreams*(self: DiscovererInfo): seq[DiscovererContainerInfo] =
  let resul0 = gst_discoverer_info_get_container_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererContainerInfo, resul0, true)
  g_list_free(resul0)

proc containerStreams*(self: DiscovererInfo): seq[DiscovererContainerInfo] =
  let resul0 = gst_discoverer_info_get_container_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererContainerInfo, resul0, true)
  g_list_free(resul0)
...
proc getLanguage*(self: DiscovererSubtitleInfo): string =
  let resul0 = gst_discoverer_subtitle_info_get_language(cast[ptr DiscovererSubtitleInfo00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getSubtitleStreams*(self: DiscovererInfo): seq[DiscovererSubtitleInfo] =
  let resul0 = gst_discoverer_info_get_subtitle_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererSubtitleInfo, resul0, true)
  g_list_free(resul0)

proc subtitleStreams*(self: DiscovererInfo): seq[DiscovererSubtitleInfo] =
  let resul0 = gst_discoverer_info_get_subtitle_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererSubtitleInfo, resul0, true)
  g_list_free(resul0)
...
proc getVideoStreams*(self: DiscovererInfo): seq[DiscovererVideoInfo] =
  let resul0 = gst_discoverer_info_get_video_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererVideoInfo, resul0, true)
  g_list_free(resul0)

proc videoStreams*(self: DiscovererInfo): seq[DiscovererVideoInfo] =
  let resul0 = gst_discoverer_info_get_video_streams(cast[ptr DiscovererInfo00](self.impl))
  result = glistObjects2seq(DiscovererVideoInfo, resul0, true)
  g_list_free(resul0)
...
proc getDescription*(self: EncodingProfile): string =
  let resul0 = gst_encoding_profile_get_description(cast[ptr EncodingProfile00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc gst_encoding_profile_get_element_properties(self: ptr EncodingProfile00): ptr gst.Structure00 {.
    importc, libprag.}

proc getElementProperties*(self: EncodingProfile): gst.Structure =
  let impl0 = gst_encoding_profile_get_element_properties(cast[ptr EncodingProfile00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstStructure)
  result.impl = impl0

proc elementProperties*(self: EncodingProfile): gst.Structure =
  let impl0 = gst_encoding_profile_get_element_properties(cast[ptr EncodingProfile00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstStructure)
...
proc getFileExtension*(self: EncodingProfile): string =
  let resul0 = gst_encoding_profile_get_file_extension(cast[ptr EncodingProfile00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getName*(self: EncodingProfile): string =
  let resul0 = gst_encoding_profile_get_name(cast[ptr EncodingProfile00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getPreset*(self: EncodingProfile): string =
  let resul0 = gst_encoding_profile_get_preset(cast[ptr EncodingProfile00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getPresetName*(self: EncodingProfile): string =
  let resul0 = gst_encoding_profile_get_preset_name(cast[ptr EncodingProfile00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
proc getRestriction*(self: EncodingProfile): gst.Caps =
  let impl0 = gst_encoding_profile_get_restriction(cast[ptr EncodingProfile00](self.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc gst_encoding_profile_set_element_properties(self: ptr EncodingProfile00;
    elementProperties: ptr gst.Structure00) {.
    importc, libprag.}

proc setElementProperties*(self: EncodingProfile; elementProperties: gst.Structure) =
  gst_encoding_profile_set_element_properties(cast[ptr EncodingProfile00](self.impl), cast[ptr gst.Structure00](g_boxed_copy(gst_structure_get_type(), elementProperties.impl)))

proc `elementProperties=`*(self: EncodingProfile; elementProperties: gst.Structure) =
  gst_encoding_profile_set_element_properties(cast[ptr EncodingProfile00](self.impl), cast[ptr gst.Structure00](g_boxed_copy(gst_structure_get_type(), elementProperties.impl)))
...
proc getPath*(self: EncodingTarget): string =
  let resul0 = gst_encoding_target_get_path(cast[ptr EncodingTarget00](self.impl))
  if resul0.isNil:
    return
  result = $resul0
...
const PLUGINS_BASE_VERSION_MICRO* = 2'i32

const PLUGINS_BASE_VERSION_MINOR* = 24'i32

const PLUGINS_BASE_VERSION_NANO* = 0'i32

type
  PbUtilsCapsDescriptionFlag* {.size: sizeof(cint), pure.} = enum
    container = 0
    audio = 1
    video = 2
    image = 3
...
proc codecUtilsAacGetLevel*(audioConfig: seq[uint8] | string): string =
  let len = int(audioConfig.len)
  let resul0 = gst_codec_utils_aac_get_level(cast[ptr uint8](unsafeaddr(audioConfig[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsAacGetProfile*(audioConfig: seq[uint8] | string): string =
  let len = int(audioConfig.len)
  let resul0 = gst_codec_utils_aac_get_profile(cast[ptr uint8](unsafeaddr(audioConfig[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc gst_codec_utils_caps_from_mime_codec(codecsField: cstring): ptr gst.Caps00 {.
    importc, libprag.}

proc codecUtilsCapsFromMimeCodec*(codecsField: cstring): gst.Caps =
  let impl0 = gst_codec_utils_caps_from_mime_codec(codecsField)
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0

proc gst_codec_utils_caps_get_mime_codec(caps: ptr gst.Caps00): cstring {.
    importc, libprag.}

proc codecUtilsCapsGetMimeCodec*(caps: gst.Caps): string =
  let resul0 = gst_codec_utils_caps_get_mime_codec(cast[ptr gst.Caps00](caps.impl))
  if resul0.isNil:
    return
  result = $resul0
  cogfree(resul0)
...
proc codecUtilsH264GetLevel*(sps: seq[uint8] | string): string =
  let len = int(sps.len)
  let resul0 = gst_codec_utils_h264_get_level(cast[ptr uint8](unsafeaddr(sps[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsH264GetProfile*(sps: seq[uint8] | string): string =
  let len = int(sps.len)
  let resul0 = gst_codec_utils_h264_get_profile(cast[ptr uint8](unsafeaddr(sps[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0

proc gst_codec_utils_h264_get_profile_flags_level(codecData: ptr uint8; len: uint32;
    profile: var uint8; flags: var uint8; level: var uint8): gboolean {.
    importc, libprag.}

proc codecUtilsH264GetProfileFlagsLevel*(codecData: seq[uint8] | string;
    profile: var uint8 = cast[var uint8](nil); flags: var uint8 = cast[var uint8](nil);
    level: var uint8 = cast[var uint8](nil)): bool =
  let len = int(codecData.len)
  toBool(gst_codec_utils_h264_get_profile_flags_level(cast[ptr uint8](unsafeaddr(codecData[0])), uint32(len), profile, flags, level))
...
proc codecUtilsH265GetLevel*(profileTierLevel: seq[uint8] | string): string =
  let len = int(profileTierLevel.len)
  let resul0 = gst_codec_utils_h265_get_level(cast[ptr uint8](unsafeaddr(profileTierLevel[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsH265GetProfile*(profileTierLevel: seq[uint8] | string): string =
  let len = int(profileTierLevel.len)
  let resul0 = gst_codec_utils_h265_get_profile(cast[ptr uint8](unsafeaddr(profileTierLevel[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsH265GetTier*(profileTierLevel: seq[uint8] | string): string =
  let len = int(profileTierLevel.len)
  let resul0 = gst_codec_utils_h265_get_tier(cast[ptr uint8](unsafeaddr(profileTierLevel[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsMpeg4videoGetLevel*(visObjSeq: seq[uint8] | string): string =
  let len = int(visObjSeq.len)
  let resul0 = gst_codec_utils_mpeg4video_get_level(cast[ptr uint8](unsafeaddr(visObjSeq[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsMpeg4videoGetProfile*(visObjSeq: seq[uint8] | string): string =
  let len = int(visObjSeq.len)
  let resul0 = gst_codec_utils_mpeg4video_get_profile(cast[ptr uint8](unsafeaddr(visObjSeq[0])), uint32(len))
  if resul0.isNil:
    return
  result = $resul0
...
proc codecUtilsOpusCreateCaps*(rate: int; channels: uint8; channelMappingFamily: uint8;
  ...
  let impl0 = gst_codec_utils_opus_create_caps(uint32(rate), channels, channelMappingFamily, streamCount, coupledCount, cast[ptr uint8](unsafeaddr(channelMapping[0])))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc codecUtilsOpusCreateCapsFromHeader*(header: gst.Buffer; comments: gst.Buffer = nil): gst.Caps =
  let impl0 = gst_codec_utils_opus_create_caps_from_header(cast[ptr gst.Buffer00](header.impl), if comments.isNil: nil else: cast[ptr gst.Buffer00](comments.impl))
  if impl0.isNil:
    return nil
  fnew(result, gBoxedFreeGstCaps)
  result.impl = impl0
...
proc codecUtilsOpusCreateHeader*(rate: int; channels: uint8; channelMappingFamily: uint8;
  ...
  let impl0 = gst_codec_utils_opus_create_header(uint32(rate), channels, channelMappingFamily, streamCount, coupledCount, cast[ptr uint8](unsafeaddr(channelMapping[0])), preSkip, outputGain)
  if impl0.isNil:
    return nil
...
proc codecUtilsOpusParseCaps*(caps: gst.Caps; rate: var int = cast[var int](nil);
    channels: var uint8 = cast[var uint8](nil); channelMappingFamily: var uint8 = cast[var uint8](nil);
    streamCount: var uint8 = cast[var uint8](nil); coupledCount: var uint8 = cast[var uint8](nil);
    channelMapping: var ptr array[256, uint8] = cast[var ptr array[256, uint8]](nil)): bool =
  var rate_00: uint32
...
proc codecUtilsOpusParseHeader*(header: gst.Buffer; rate: var int = cast[var int](nil);
    channels: var uint8 = cast[var uint8](nil); channelMappingFamily: var uint8 = cast[var uint8](nil);
    streamCount: var uint8 = cast[var uint8](nil); coupledCount: var uint8 = cast[var uint8](nil);
    channelMapping: var ptr array[256, uint8] = cast[var ptr array[256, uint8]](nil);
    preSkip: var uint16 = cast[var uint16](nil); outputGain: var int16 = cast[var int16](nil)): bool =
  var rate_00: uint32
...
proc gst_pb_utils_get_caps_description_flags(caps: ptr gst.Caps00): PbUtilsCapsDescriptionFlags {.
    importc, libprag.}

proc pbUtilsGetCapsDescriptionFlags*(caps: gst.Caps): PbUtilsCapsDescriptionFlags =
  gst_pb_utils_get_caps_description_flags(cast[ptr gst.Caps00](caps.impl))
...
proc gst_pb_utils_get_file_extension_from_caps(caps: ptr gst.Caps00): cstring {.
    importc, libprag.}

proc pbUtilsGetFileExtensionFromCaps*(caps: gst.Caps): string =
  let resul0 = gst_pb_utils_get_file_extension_from_caps(cast[ptr gst.Caps00](caps.impl))
  if resul0.isNil:
    return
  result = $resul0
  cogfree(resul0)
