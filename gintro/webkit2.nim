...
import harfbuzz, gdkpixbuf, xlib, freetype2, javascriptcore, glib, soup, gmodule, gtk, cairo, gobject, gdk, gio, atk, pango
...
proc getAllCookiesFinish*(self: CookieManager; resu: gio.AsyncResult): seq[soup.Cookie] =
  var gerror: ptr glib.Error
...
proc replaceCookies*(self: CookieManager; cookies: seq[soup.Cookie];
    cancellable: gio.Cancellable = nil; callback: AsyncReadyCallback; userData: pointer) =
...
proc setHttpHeaders*(self: URISchemeResponse;
  ...
  webkit_uri_scheme_response_set_http_headers(cast[ptr URISchemeResponse00](self.impl), cast[ptr soup.MessageHeaders00](g_boxed_copy(soup_message_headers_get_type(), headers.impl)))
